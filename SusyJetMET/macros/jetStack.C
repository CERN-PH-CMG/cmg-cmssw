{
  ...
  TProfile* p7 = (TProfile*)gDirectory->Get( (string("pfJetHistograms/Muons/")+dim).c_str());
  ...
  TH1F* h7 = (TH1F*) p7->ProjectionX();

  THStack vsEta("vsEta","");
  
  Styles styles;
  
  const char* title = ";#eta";
  bool solid=true;
  Styles::FormatHisto(h1, styles.spred,   title, solid);
  Styles::FormatHisto(h2, styles.spblue,  title, solid);
  Styles::FormatHisto(h3, styles.spgreen, title, solid);
  Styles::FormatHisto(h4, styles.spyellow,title, solid);
  Styles::FormatHisto(h5, styles.sppink1, title, solid);
  Styles::FormatHisto(h6, styles.sppink2, title, solid);
  Styles::FormatHisto(h7, styles.spgray, title, solid);
