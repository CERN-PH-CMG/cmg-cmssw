...
class CmgdbToolsApi(CmgdbApi):
    ...
    def addGoodFileNum(self, datasetID,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set number_files_good=%d where dataset_id = %d" % (number, datasetID))
    ...
    def addGroupGoodFileNum(self, group_id,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.file_group_details set number_files_good=%d where file_group_id=%d" % (number,group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def clearDatasetMissingFiles(self, dsName, datasetID):
        ...
        """
        try:
            self.insertCur.execute('DELETE FROM cmgbookkeepingtest.missing_files WHERE dataset_id = %d' % int(datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
    ...
    def addMissingFileNum(self,datasetID,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set number_files_missing=%d where dataset_id = %d" % (number, datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def addGroupMissingFileNum(self, group_id,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.file_group_details set number_files_missing=%d where file_group_id=%d" % (number,
                                                                                                                   group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def addMissingFile(self, dsName, datasetID, missingFileName, group_id):
        ...
        """
        try:
            self.insertCur.execute("INSERT INTO cmgbookkeepingtest.missing_files(dataset_id, missing_file, file_group_id) values(%d, '%s', %d)" % (datasetID,
                                                                                                                              missingFileName,
                                                                                                                              group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
    ...
    def clearDatasetBadFiles(self, dsName, datasetID):
        ...
        """
        try:
            self.insertCur.execute('DELETE FROM cmgbookkeepingtest.bad_files WHERE dataset_id = %d' % int(datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
    ...
    def addBadFileNum(self,datasetID,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set number_files_bad=%d where dataset_id = %d" % (number,
                                                                                                           datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def addGroupBadFileNum(self,group_id,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.file_group_details set number_files_bad=%d where file_group_id=%d" % (number,
                                                                                                               group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def addBadFile(self, dsName, datasetID, badFileName, group_id):
        ...
        """
        try:
            self.insertCur.execute("INSERT INTO cmgbookkeepingtest.bad_files(dataset_id, bad_file, file_group_id) values(%d, '%s', %d)" % (datasetID,
                                                                                                                      str(badFileName),
                                                                                                                      group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
    ...
    def clearDatasetBadJobs(self, dsName, datasetID):
        ...
        """
        try:
            self.insertCur.execute('DELETE FROM cmgbookkeepingtest.bad_jobs WHERE dataset_id = %d' % int(datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
    ...
    def addBadJob(self, datasetID, badJobNum):
        ...
        """
        try:
            self.insertCur.execute('INSERT INTO cmgbookkeepingtest.bad_jobs(dataset_id, bad_job) values(%d, %d)' % (datasetID,
                                                                                               int(badJobNum)))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            #If exception is thrown display error message and ignore
    ...
    def addBadJobNum(self,datasetID,number):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set number_jobs_bad=%d where dataset_id = %d" % (number,
                                                                                                          datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def addTotalJobs(self, datasetID, nJobs):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set number_total_jobs=%d where dataset_id = %d" % (nJobs,
                                                                                                            datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            print "Dataset not found"
    ...
    def addTag(self, package, tag):
        ...
        try:
            ...
            if tagID!= None:
                return tagID
            tagID = self.selectCur.execute("select cmgbookkeepingtest.tag_id_seq.NEXTVAL from dual").fetchone()[0]
            self.insertCur.execute("INSERT INTO cmgbookkeepingtest.tags(tag_id, package_name, tag) values(:tagID , :package, :tag)",
                       {"tagID":tagID,"package":package,"tag":tag})
            self.insertConn.commit()
            return tagID
        except cx_Oracle.IntegrityError:
            #If exception is thrown display error message and ignore
    ...
    def addDataset(self, dsName,eos,lfn, fileOwner, parentID, username):
        ...
        try:
            ...
            datasetID = self.selectCur.execute("select cmgbookkeepingtest.dataset_id_seq.NEXTVAL from dual").fetchone()[0]
            if parentID is None:self.insertCur.execute("INSERT INTO cmgbookkeepingtest.dataset_details(dataset_id,parent_dataset_id,cmgdb_name,path_name,lfn,date_recorded,last_commented,file_owner,published_by) values(%d,NULL,'%s','%s','%s',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'%s','%s')" % (datasetID,dsName,eos,lfn,fileOwner, username))
            else: self.insertCur.execute("INSERT INTO cmgbookkeepingtest.dataset_details(dataset_id,parent_dataset_id,cmgdb_name,path_name,lfn,date_recorded,last_commented,file_owner,published_by) values(%d,%d,'%s','%s','%s',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'%s','%s')" % (datasetID,parentID,dsName,eos,lfn,fileOwner, username))
            self.insertConn.commit()
            return datasetID
        except cx_Oracle.IntegrityError:
    ...
    def addFileGroup(self, group_name,cmgdb_id):
        ...
        try:
            ...
            if group_id is not None:
                return group_id
            #Insert information into database
            group_id = self.selectCur.execute("select cmgbookkeepingtest.file_group_id_seq.NEXTVAL from dual").fetchone()[0]
            self.insertCur.execute("INSERT INTO cmgbookkeepingtest.file_group_details(file_group_id,dataset_id,file_group_name) values(%d,%d,'%s')" % (group_id,
                                                                                                                                  cmgdb_id,
                                                                                                                                  group_name))
            self.insertConn.commit()
            return group_id
    ...
    def getGroupIDWithDatasetAndName(self,group_name,cmgdb_id):
        ...
        try:
            return self.selectCur.execute("SELECT file_group_id from cmgbookkeepingtest.file_group_details where file_group_name='%s' and dataset_id=%d" % (group_name,
                                                                                                                                       cmgdb_id)).fetchone()[0]
        except:
            return None
    ...
    def closeDataset(self, dsName):
        ...
        try:
            # Insert information into database
            datasetID = self.insertCur.execute("update cmgbookkeepingtest.dataset_details set dataset_is_open='N' where cmgdb_name = '%s'" % dsName)
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            #If set is already in the database then print error message and ignore
    ...
    def addPrimaryDatasetFraction(self,datasetID, fraction):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set dataset_fraction='%f' WHERE dataset_id='%d'" % (fraction,
                                                                                                             datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
    ...
    def addGroupPrimaryDatasetFraction(self,group_id, fraction):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.file_group_details set dataset_fraction='%f' WHERE file_group_id='%d'" % (fraction,
                                                                                                                   group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            # If set doesn't exist print error message and ignore
    ...
    def addDatasetSize(self,group_id, size):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.file_group_details set dataset_size_in_tb='%f' WHERE file_group_id='%d'" % (size,
                                                                                                                     group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            # If set doesn't exist print error message and ignore
    ...
    def addDirectorySize(self,datasetID, size):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set dataset_size_in_tb='%f' WHERE dataset_id='%d'" % (size,
                                                                                                               datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            # If set doesn't exist print error message and ignore
    ...
    def addFileEntries(self,datasetID, entries):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set dataset_entries='%d' WHERE dataset_id='%d'" % (int(entries),
                                                                                                            datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            # If set doesn't exist print error message and ignore
    ...
    def addGroupFileEntries(self,group_id, entries):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.file_group_details set dataset_entries='%d' WHERE file_group_id='%d'" % (int(entries),
                                                                                                                  group_id))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            # If set doesn't exist print error message and ignore
    ...
    def addPrimaryDatasetEntries(self,datasetID, entries):
        ...
        """
        try:
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set primary_dataset_entries='%d' WHERE dataset_id='%d'" % (int(entries),
                                                                                                                    datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            # If set doesn't exist print error message and ignore
    ...
    def getDatasetIDWithName(self, datasetName):
        ...
        """
        try:
            return self.selectCur.execute("SELECT dataset_id from cmgbookkeepingtest.dataset_details where cmgdb_name='%s'" % datasetName).fetchone()[0]
        except:
            return None
    ...
    def getParentsWithName(self, datasetName):
        ...
        try:
            ...
            datasets = self.selectCur.execute("SELECT cmgdb_name, dataset_id from cmgbookkeepingtest.dataset_details where cmgdb_name LIKE '%s' and dataset_is_open='Y'" % strippedDSName)
            checkedDatasets = []
            for row in datasets:
    ...
    def getDatasetIDWithTaskID(self,taskID,test):
        ...
        try:
            return self.selectCur.execute("SELECT dataset_id from cmgbookkeepingtest.dataset_details where %s=%d" % (taskType,
                                                                                                int(taskID))).fetchone()[0]
        except:
    ...
    def addTaskID(self, datasetID, taskID, test):
        ...
        try:
            ...
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set last_commented = CURRENT_TIMESTAMP WHERE dataset_id=%d" % int(datasetID))
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set task_id=%d WHERE dataset_id=%d" % ( int(taskID),
                                                                                                                      int(datasetID) ))
            self.insertConn.commit()
    ...
    def addTagSetID(self, tagsetID, datasetID):
        """Update the column "tagset_id" in the table cmgbookkeepingtest.dataset_details to the unique cmgdb tagset id of the given dataset
        ...
        try:
            ...
            self.insertCur.execute("UPDATE cmgbookkeepingtest.dataset_details set tagset_id='%d' WHERE dataset_id=%d" % (tagsetID,
                                                                                                    datasetID))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            #If set doesn't exist print error message and ignore
    ...
    def getTagID(self, package, tag):
        ...
        row =  self.selectCur.execute("SELECT tag_id FROM cmgbookkeepingtest.tags WHERE package_name = :package AND tag=:tag",
    ...
    def getTaskID(self, datasetID, test):
        ...
        try:
            ...
            # Insert information into database
            if test == True: taskType = "test_task_id"
            return self.selectCur.execute("SELECT %s from cmgbookkeepingtest.dataset_details where dataset_id='%d'" % (taskType,
                                                                                                  datasetID)).fetchone()[0]
        except:return None
    ...
    def getTags(self, datasetID):
        ...
        try:
            ...
            setID = self.selectCur.execute("Select tagset_id from cmgbookkeepingtest.dataset_details where dataset_id='%d'"% datasetID).fetchone()[0]
            tagDicts = []
            # Get a list of the tags in the tagset
            tags = self.selectCur.execute("select * from cmgbookkeepingtest.tags where tagset_id = '%d'" % setID)
    ...
    def addTagSet(self, release, hash):
        ...
        tagSetID = self.selectCur.execute("select cmgbookkeepingtest.set_id_seq.NEXTVAL from dual").fetchone()[0]
        self.insertCur.execute("insert into cmgbookkeepingtest.tag_sets values(:tagSetID, :release, :hash)",
                       {"tagSetID":tagSetID,"release":release,"hash":hash})
        try:
            self.insertConn.commit()
            return tagSetID
        except:
    ...
    def addTagToSet(self, tagID, tagSetID):
        """ Add a tag to a tagset by adding the unique CMGDG ID's of both the tagset and the tag to the table cmgbookkeepingtest.tags_in_sets

        'tagID' takes the unique CMGDB Tag ID as an int
        'tagSetID' takes the unique CMGDB Tagset ID as an int
        """
        try:
            self.insertCur.execute("insert into cmgbookkeepingtest.tags_in_sets values(:setID,:tag)",
                       {"setID":tagSetID,"tag":tagID})
        except cx_Oracle.IntegrityError:
    ...
    def getTagSetID(self, hash):
        ...
        """
        try:
            set = self.selectCur.execute("select tagset_id from cmgbookkeepingtest.tag_sets where tag_hash=%d" % hash).fetchone()
            return set[0]
        except:
            return None
    ...
    def addValidationRun( self, tagSetID, numberOfEventsProcessed ):
        validationRunID = self.selectCur.execute("select cmgbookkeepingtest.validation_run_id_seq.NEXTVAL from dual").fetchone()[0]
        try:
            self.insertCur.execute("INSERT INTO cmgbookkeepingtest.validation_run_details(validation_run_id, validation_run_tagset_id, events_processed) values(%d, %d, %d)" % (validationRunID, tagSetID, int(numberOfEventsProcessed)))
            self.insertConn.commit()
        except cx_Oracle.IntegrityError:
            #If exception is thrown display error message and ignore
    ...
    def addAnalyzer( self, analyzerName ):
        try:
            analyzerID = self.selectCur.execute("select analyzer_id from cmgbookkeepingtest.analyzers where analyzer_name='%s'" % analyzerName).fetchone()[0]
        except:
            analyzerID =  self.selectCur.execute("select cmgbookkeepingtest.analyzer_id_seq.NEXTVAL from dual").fetchone()[0]
            try:
                self.insertCur.execute("INSERT INTO cmgbookkeepingtest.analyzers(analyzer_id, analyzer_name) values(%d, '%s')" % (analyzerID,
                                                                                                                                analyzerName))
                self.insertConn.commit()
            except cx_Oracle.IntegrityError:
            #If exception is thrown display error message and ignore
    ...
    def addRootFilesToValidationRunWithAnalyzerOnDataset( self, validationRunID, eosPath, dir_name, analyzer_name, root_file ):
        try:
            ...
            datasetInfo = self.selectCur.execute( "SELECT dataset_id,file_owner, path_name from cmgbookkeepingtest.dataset_details where lfn='%s'" % lfnPath ).fetchone()
        except:
            print "ERROR - Could not find parent dataset of the analysis in CMGDB"
            exit( -1 )

        try: 
            self.insertCur.execute( "INSERT INTO cmgbookkeepingtest.validation_root_files_details( validation_run_id, dataset_id, dir_name,  analyzer_name, root_file_name ) values(%d, %d, '%s', '%s', '%s')" % (validationRunID,
                                                                                                                                                                                            datasetInfo[0],
                                                                                                                                                                                            dir_name,
                                                                                                                                                                                            analyzer_name,
                                                                                                                                                                                            root_file ) )
    ...
    def getValidationRunDetailsFromName( self, dir_name ):
        try:
            validationRunDetails = self.selectCur.execute( "SELECT validation_run_id, events_processed from cmgbookkeepingtest.validation_run_details where dir_name='%s'" % dir_name ).fetchone()
        except:
    ...
    def getRootFileInfoFromValidationRunID( self, validationID ):
        try:
            rootFileInfo = self.selectCur.execute( "SELECT dir_name, lfn, analyzer_name, root_file_name FROM cmgbookkeepingtest.validation_root_files_details, cmgbookkeepingtest.analyzers, cmgbookkeepingtest.dataset_details WHERE cmgbookkeepingtest.dataset_details.dataset_id = cmgbookkeepingtest.validation_root_files_details.dataset_id AND cmgbookkeepingtest.validation_root_files_details.analyzer_id = cmgbookkeepingtest.analyzers.analyzer_id AND validation_run_id='%d'" % validationID ).fetchall()
        except:
