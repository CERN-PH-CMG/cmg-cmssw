...
os.system("runPlotter --iEcm 8 --iLumi 1620 --inDir resultsRescaled/ --outDir $CMSSW_BASE/src/CMGTools/HtoZZ2l2nu/test/resultsRescaled/plots2012/ --outFile $CMSSW_BASE/src/CMGTools/HtoZZ2l2nu/test/plotter2012Rescaled.root  --json $CMSSW_BASE/src/CMGTools/HtoZZ2l2nu/data/samples_2012Rescaled.json --noRoot")
