...
\RCS$Id: AN-11-higgs.tex,v 1.33 2011/09/14 10:04:25 psilva Exp $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
In the previous section it was noticed that by taking the minimum of the \MET measurement and the \tkMET measurement for each event
we can obtain an estimate of the \MET which is more robust against the contamination from pileup.
The drawback of this approach is the loss of resolution in the measurement as \tkMET uses only the charged component of the event
...
The approach followed is summarized as follows:
...
Three extra \MET types are defined: residual (\resMET) built from all the candidates associated to secondary vertices,
clustered (\clusMET) built from all the candidates associated to the primary vertex and clean (\cleanMET) computed
...
&                                                        & \MET           & \tkMET         & \resMET        & \clusMET         & \cleanMET      \\\hline
\multirow{3}{*}{charged}  & all ($|\eta|<$2.4)           & $\blacksquare$ &                &                &                  & $\blacksquare$ \\
                          & assoc. prim. vertex          &                & $\blacksquare$ &                & $\blacksquare$   &               \\
                          & assoc. other vertices        &                &                & $\blacksquare$ &                  & $\Box$        \\\hline
\multirow{3}{*}{neutrals} & all ($|\eta|<$5)             & $\blacksquare$ &                &                &                  & $\blacksquare$ \\
                          & assoc. prim. vertex          &                &                &                & $\blacksquare$   &                \\
                          & assoc. other vertices        &                &                & $\blacksquare$ &                  & $\Box$         \\\hline\hline
\end{tabular}
\end{center}
\end{table}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[width=0.3\textwidth]{img/mumueq0jets_Likelihoodtight_200}
\includegraphics[width=0.3\textwidth]{img/mumueq1jets_Likelihoodtight_200}
\includegraphics[width=0.3\textwidth]{img/mumugeq2jets_Likelihoodtight_200}\\
\includegraphics[width=0.3\textwidth]{img/eeeq0jets_Likelihoodtight_200}
\includegraphics[width=0.3\textwidth]{img/eeeq1jets_Likelihoodtight_200}
\includegraphics[width=0.3\textwidth]{img/eegeq2jets_Likelihoodtight_200}
...
Total expected                      &  0.799 $\pm$ 0.572 & 0.240 $\pm$ 0.175 \\\hline
Data                                & 1                  &  \\\hline\hline
\end{tabular}
\end{center}
\end{table}
...
\section{Appendix: Control distributions for the discriminant-based analysis}
