...
\RCS$Id: AN-11-higgs.tex,v 1.3 2011/08/22 22:27:17 psilva Exp $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
and which may mimick the signal under study  .
...
The integrated luminosity and the run range corresponding to different data are shown in the rightmost columns. All samples are AOD.}
\label{tab:datasamples}
\begin{center}
\begin{tabular}{lll} \hline\hline
\multicolumn{3}{c}{\bf Data samples} \\
Dataset                         & $\int \mathcal{L}$ (pb$^{-1}$)  & Run range \\\hline
/PD/Run2011A-May10ReReco-v1/AOD &                                 & {\small 160431-163869} \\
