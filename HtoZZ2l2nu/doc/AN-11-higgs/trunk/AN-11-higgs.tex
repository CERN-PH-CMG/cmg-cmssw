...
\RCS$Id: AN-11-higgs.tex,v 1.36 2011/09/14 15:06:58 psilva Exp $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
Fig.~\ref{fig:metcorrelations} ({\em bottom}) depicts the correlation between \MET and \clusMET.
It can be observed that while the resolution of \clustMET is slightly worse with respect to \tkMET,
...
\caption{Correlation between \MET and \tkMET ({\em top})
 and between \MET and \clusMET ({\em bottom})
