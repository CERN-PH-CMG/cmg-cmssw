...
//  .x performanceComparison.C+("ImgDY/H150/", "mumu","H(150)","Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
  ...
  .x performanceComparison.C+("ImgDY/H500/", "mumu","H(500)","Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
...
//  .x performanceComparison.C+("ImgSM/H400/", "mumu","H(400)","ZZ|WW|WZ|Single top|t#bar{t}|W+jets|Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
//  .x performanceComparison.C+("ImgSM/H600/", "mumu","H(600)","ZZ|WW|WZ|Single top|t#bar{t}|W+jets|Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
EOF                                   
