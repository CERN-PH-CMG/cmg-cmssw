...
process.PF2PAT.remove( process.pfMuonsFromVertex )
process.pfSelectedMuons.src = 'pfAllMuons'
process.PF2PAT.remove( process.pfElectronsFromVertex )
process.pfSelectedElectrons.src = 'pfAllElectrons'
process.PF2PAT.remove( process.pfTauSequence )
process.PF2PAT.remove( process.pfNoTau )
