...
int igraph=0;  // plot signal ratio for method 2 and 3 -->igraph=1
int iprint=0;
...
if(j==0 && meantest!=1000) j=1; // fit doesn't converge at 1000 GeV
...
if(igraph==1)
{
if(exec2==1 && exec3==1) graphratio(M2SigBkg1->GetParameter(10),M2SigBkg1->GetParError(10),M2SigBkg2->GetParameter(10), M2SigBkg2->GetParError(10),M2SigBkg3->GetParameter(10),M2SigBkg3->GetParError(10),M3SigBkg1->GetParameter(10),M3SigBkg1->GetParError(10),M3SigBkg2->GetParameter(10), M2SigBkg2->GetParError(10),M3SigBkg3->GetParameter(10), M2SigBkg3->GetParError(10));
}
...
void graphratio(double meth2p1,double meth2errorp1,double meth2p2, double meth2errorp2, double meth2p3, double meth2errorp3,double meth3p1,double meth3errorp1,double meth3p2, double meth3errorp2, double meth3p3, double meth3errorp3)
{
...
r3[0]=meth3p1/(meth3p1+meth3p2+meth3p3);
r3[1]=meth3p2/(meth3p1+meth3p2+meth3p3);
r3[2]=meth3p3/(meth3p1+meth3p2+meth3p3);
...
r3errorlow[0]=0.;
r3errorlow[1]=0.;xmax/BinWidth*NBin
r3errorlow[2]=0.;
r3errorhigh[0]=0.;
r3errorhigh[1]=0.;
r3errorhigh[2]=0.;
