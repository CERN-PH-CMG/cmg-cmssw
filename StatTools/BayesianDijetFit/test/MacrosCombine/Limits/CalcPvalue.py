...
#    masses =[1200.0]
    for mass in masses:
        ...
        if chan == 0:
            os.system("combine ../datacards/Xvv.mX"+str(mass)+"_WW_8TeV_channel2.txt -M ProfileLikelihood -v2 -m "+str(mass) + " --signif &>Xvv.mX"+str(mass)+"_WW_8TeV_channel2.out")
            f_fit=file("Xvv.mX"+str(mass)+"_WW_8TeV_channel2.out")

        if chan == 1:
            os.system("combine ../datacards/Xvv.mX"+str(mass)+"_ZZ_8TeV_channel2.txt -M ProfileLikelihood -v2 -m "+str(mass) + " --signif &>Xvv.mX"+str(mass)+"_ZZ_8TeV_channel2.out")
            f_fit=file("Xvv.mX"+str(mass)+"_ZZ_8TeV_channel2.out")
...
fWW = open("Xvv_WW_8TeV_Pval_channel2.txt", "w")
fWW.write(str(sPvalWW))
fWW.close()

fZZ = open("Xvv_ZZ_8TeV_Pval_channel2.txt", "w")
fZZ.write(str(sPvalZZ))
fZZ.close()


fWW = open("Xvv_WW_8TeV_Sig_channel2.txt", "w")
fWW.write(str(sSigWW))
fWW.close()

fZZ = open("Xvv_ZZ_8TeV_Sig_channel2.txt", "w")
