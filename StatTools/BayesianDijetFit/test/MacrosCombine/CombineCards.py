...
for mass in masses:
  ...
  print command
  os.system(command)
  command="combineCards.py ch0=datacards/Xvv.mX"+str(mass)+"_WZ_8TeV_channel0.txt ch1=datacards/Xvv.mX"+str(mass)+"_WZ_8TeV_channel1.txt ch2=datacards/Xvv.mX"+str(mass)+"_WZ_8TeV_channel2.txt > datacards/Xvv.mX"+str(mass)+"_WZ_8TeV_channel012.txt"
  print command
  os.system(command)
