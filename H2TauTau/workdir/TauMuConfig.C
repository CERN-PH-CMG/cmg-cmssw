{  
  ...
  //TString path="./output/Test";

  //TString path="./output/21fbCatSVFitRecoil";
  TString path="./output/21fbMETSig";  
  //TString path="./output/21fbMETSigFix";//did not fix svfit mass

  analysis.setOutputPath(path);

  TString datapath="/data/benitezj/RootFiles";

  /////////////////////////
  //define samples    
  /////////////////////////
  Sample WJetsToLNu("WJetsToLNu",(const char*)(datapath+"/WJetsToLNu_TuneZ2_7TeV-madgraph-tauola/Summer11-PU_S4_START42_V11-v1/AODSIM/V2/PAT_CMG_V2_3_0/cmgTauMu"));
  ...
  Sample TTJets("TTJets",(const char*)(datapath+"/TTJets_TuneZ2_7TeV-madgraph-tauola/Summer11-PU_S4_START42_V11-v1/AODSIM/V2/PAT_CMG_V2_3_0/cmgTauMu"));
  ...
  Sample ZToMuMu("ZToMuMu",(const char*)(datapath+"/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Summer11-PU_S4_START42_V11-v1/AODSIM/V2/PAT_CMG_V2_3_0/cmgTauMu"));
  ...
  Sample ZToTauTau("ZToTauTau",(const char*)(datapath+"/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Summer11-PU_S4_START42_V11-v1/AODSIM/V2/PAT_CMG_V2_3_0/cmgTauMu"));
  ...
  Sample ZToLJet("ZToLJet",(const char*)(datapath+"/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola/Summer11-PU_S4_START42_V11-v1/AODSIM/V2/PAT_CMG_V2_3_0/cmgTauMu"));
  ...
  Sample Higgs("Higgs",(const char*)(datapath+"/GluGluToHToTauTau_M-115_7TeV-powheg-pythia6/Summer11-PU_S4_START42_V11-v1/AODSIM/V2/PAT_CMG_V2_3_0/TauMu"));
...
//   Sample SingleMuMay("SingleMuMay",(const char*)(datapath+"/SingleMu/Run2011A-May10ReReco-v1/AOD/V2/PAT_CMG_V2_3_0/cmgTauMu"));
...
//   analysis.addSample(&SingleMuMay);
  ...
  Sample TauPlusXMay("TauPlusXMay",(const char*)(datapath+"/TauPlusX/Run2011A-May10ReReco-v1/AOD/V2/PAT_CMG_V2_3_0/TauMu"));
  ...
  Sample TauPlusXv4("TauPlusXv4",(const char*)(datapath+"/TauPlusX/Run2011A-PromptReco-v4/AOD/V2/PAT_CMG_V2_3_0/TauMu"));
  ...
  Sample TauPlusXAug("TauPlusXAug",(const char*)(datapath+"/TauPlusX/Run2011A-05Aug2011-v1/AOD/V2/PAT_CMG_V2_3_0/TauMu"));
  ...
  Sample TauPlusXv6("TauPlusXv6",(const char*)(datapath+"/TauPlusX/Run2011A-PromptReco-v6/AOD/V2/PAT_CMG_V2_3_0/TauMu"));
