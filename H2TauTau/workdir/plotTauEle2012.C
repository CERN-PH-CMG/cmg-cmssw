...
//   analysis->plotInc("ditaumass",20,0,200,1,1,1,analysis->getSMcut(1),"(ditaumass<60||120<ditaumass)",2,0,"m_{vis}   (GeV)","",c,0,"mvis_0jethigh_et_2012");
//   analysis->plotInc("transversemass",30,0,300,2,1,0,analysis->getSMcut(1),"",-1,0,"m_{T} ","",c,0,"mt_1_met_0jethigh_SS_et_2012");
...
//   analysis->plotInc("transversemass",30,0,300,1,1,0,analysis->getSMcut(1),"",2,0,"m_{T} ","",c,0,"mt_1_met_0jethigh_et_2012");
...
//   analysis->plotInc("mueta",20,-2.5,2.5,1,1,1,analysis->getSMcut(2),"",0,2," electron  #eta","",c2,0,"eta_1_1jetlow_et_2012"); 
//   analysis->plotInc("taupt",25,0,100,1,1,1,analysis->getSMcut(2),"",0,2," tau pt   (GeV)","",c,0,"pt_2_1jetlow_et_2012");
//   analysis->plotInc("taueta",20,-2.5,2.5,1,1,1,analysis->getSMcut(2),"",0,2," tau  #eta","",c2,0,"eta_2_1jetlow_et_2012"); 
//   analysis->plotInc("metpt",30,0,150,1,1,0,analysis->getSMcut(2),"",0,2," MET   (GeV)","",c,0,"mvamet_1jetlow_et_2012");
//   analysis->plotInc("ditaumass",20,0,200,1,1,1,analysis->getSMcut(2),"(ditaumass<60||120<ditaumass)",0,2,"m_{vis}   (GeV)","",c,0,"mvis_1jetlow_et_2012");
//   analysis->plotInc("transversemass",30,0,300,2,1,0,analysis->getSMcut(2),"",-1,0,"m_{T} ","",c,0,"mt_1_met_1jetlow_SS_et_2012");
...
//   analysis->plotInc("mupt",25,0,100,1,1,1,analysis->getSMcut(3),"",2,2," electron pt   (GeV)","",c,0,"pt_1_1jethigh_et_2012");
//   analysis->plotInc("mueta",20,-2.5,2.5,1,1,1,analysis->getSMcut(3),"",2,2," electron  #eta","",c2,0,"eta_1_1jethigh_et_2012"); 
//   analysis->plotInc("taupt",25,0,100,1,1,1,analysis->getSMcut(3),"",2,2," tau pt   (GeV)","",c,0,"pt_2_1jethigh_et_2012");
//   analysis->plotInc("taueta",20,-2.5,2.5,1,1,1,analysis->getSMcut(3),"",2,2," tau  #eta","",c2,0,"eta_2_1jethigh_et_2012"); 
//   analysis->plotInc("metpt",30,0,150,1,1,0,analysis->getSMcut(3),"",2,2," MET   (GeV)","",c,0,"mvamet_1jethigh_et_2012");
//   analysis->plotInc("ditaumass",20,0,200,1,1,1,analysis->getSMcut(3),"(ditaumass<60||120<ditaumass)",2,2,"m_{vis}   (GeV)","",c,0,"mvis_1jethigh_et_2012");
//   analysis->plotInc("transversemass",30,0,300,2,1,0,analysis->getSMcut(3),"",-1,2,"m_{T} ","",c,0,"mt_1_met_1jethigh_SS_et_2012");
...
//   analysis->plotInc("ditaumass",20,0,200,1,1,1,analysis->getSMcut(4),"(ditaumass<60||120<ditaumass)",5,3,"m_{vis}   (GeV)","",c,0,"mvis_vbf_et_2012");
