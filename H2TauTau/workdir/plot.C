...
//   analysis->plotInc("mupt",50,0,100,1,1,"","",0,0," mu pt   (GeV)","",c,0,"nominal");
//   analysis->plotInc("mueta",50,-2.5,2.5,1,1,"","",0,0," muon  #eta","",c,0,"nominal"); 
//   analysis->plotInc("muiso",100,0,1,0,1,"(tauisodiscmva>=1)","",0,0," muon relIso","",c,0,"nominal");
//  analysis->plotInc("mudz",100,-.05,.05,1,1,"","",0,0," mu dz","",c,0,"nominal");
//  analysis->plotInc("mudxy",100,-.03,.03,1,1,"","",0,0," mu dxy","",c,0,"nominal");

//   analysis->plotInc("taupt",50,0,100,1,1,"","",0,0," tau pt   (GeV)","",c,0,"nominal");
//   analysis->plotInc("taueta",50,-2.5,2.5,1,1,"","",0,0," tau  #eta","",c2,0,"nominal"); 
//   analysis->plotInc("tauisomva",100,-1.0,1.01,0,1,"(muiso<0.1)","",0,0,"tau iso mva","",c,0,"nominal");
//  analysis->plotInc("taudz",100,-.05,.05,1,1,"","",0,0," tau dz","",c,0,"nominal");
//  analysis->plotInc("taudxy",100,-.03,.03,1,1,"","",0,0," tau dxy","",c,0,"nominal");

// analysis->plotInc("taudz-mudz",100,-.05,.05,1,1,"","",0,0," tau dz - mu dz","",c,0,"nominal");
//  analysis->plotInc("mudxy-taudxy",100,-.03,.03,1,1,"","",0,0," tau dxy - mu dxy","",c,0,"nominal");
//  analysis->plotInc("sqrt((taux-mux)*(taux-mux)+(tauy-muy)*(tauy-muy))",100,0,.05,1,1,"","",0,0,"","",c,0,"nominal");
//  analysis->plotInc("tauz-muz",100,-.05,.05,1,1,"","",0,0," tau dz - mu dz","",c,0,"nominal");
...
//  analysis->plotInc("svfitmass",0,0,350,1,1,"(categorySM==2)","(abs(svfitmass-125)>25.01)",3,5,"m(#tau#tau)    (GeV)","dN/dm(#tau#tau)",c,0,"VBF2011");

//  analysis->setSmearHistoRes(20.);//resolution on svfitmass  (abs(svfitmass-125)>25.01)
...
//   analysis->plotInc("svfitmass",0,0,350,1,1,analysis->getSMcut(0),"",0,0,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c,0,"0JetLow");
...
//   analysis->plotInc("svfitmass",0,0,350,1,1,analysis->getSMcut(1),"",0,0,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c,0,"0JetHigh");
...
//   analysis->plotInc("svfitmass",0,0,350,1,1,analysis->getSMcut(2),"",0,0,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c,0,"BoostedLow");  
...
//   analysis->plotInc("svfitmass",0,0,350,1,1,analysis->getSMcut(3),"",0,0,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c,0,"BoostedHigh");     

//  analysis->plotInc("transversemass",15,0,300,1,0,analysis->getSMcut(4),"",3,5,"m_{T} ","",c,0,"VBF_QCD3_W5");
//  analysis->plotInc("svfitmass",0,0,350,1,1,analysis->getSMcut(4),"",3,5,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c,5,"VBF_QCD3_W5");
//  analysis->plotInc("ditaumass",0,0,260,1,1,analysis->getSMcut(4),"",3,5,"m(#mu#tau)   (GeV)","",c,0,"VBF_QCD3_W5");
...
/* ----------------MSSM ----------------------------------------*/
  ...
  //analysis->plotIncSS("pZeta-1.5*pZetaVis",100,-150,100,1,-1,"",0,"pZeta-1.5*pZetaVis","",c4,0,"MSSMnominal");
  //analysis->plotInc("pZeta-1.5*pZetaVis",100,-150,100,1,-1,"","",0,0,"pZeta-1.5*pZetaVis","",c4,0,"MSSMnominal");
  //analysis->plotInc("nbjet",5,-.5,4.5,1,101,"","",0,0," nbjet ","",c4,0,"MSSMnominal");

  //analysis->plotIncSS("pZeta-1.5*pZetaVis",25,-150,100,1,-1,"(nbjet>=1)",22,"pZeta-1.5*pZetaVis","",c4,0,"MSSMnominalBJet");
  //analysis->plotInc("pZeta-1.5*pZetaVis",25,-150,100,1,-1,"(nbjet>=1)","",4,22,"pZeta-1.5*pZetaVis","",c4,0,"MSSMnominalBJet");
  //analysis->plotInc("pZeta-1.5*pZetaVis",25,-150,100,1,-1,"(nbjet>=1&&njet<2)","",4,22,"pZeta-1.5*pZetaVis","",c4,0,"MSSMnominalBJet2Jet");
  //analysis->plotInc("leadBJetPt",20,0,200,1,101,"(nbjet>=1)","",4,22," b jet p_{T}   (GeV)","",c4,0,"MSSMnominalBJet");
  //analysis->plotInc("leadBJetEta",20,-5,5,1,101,"(nbjet>=1)","",4,22," b jet #eta","",c4,0,"MSSMnominalBJet"); 
  //analysis->plotInc("svfitmass",0,0,350,1,101,"(nbjet>=1)","(svfitmass<100)",4,22,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c4,0,"MSSMnominalBJet");
  //analysis->plotInc("taupt",15,0,150,1,101,"(nbjet>=1)","",4,22,"tau pt (GeV)","",c4,0,"BJetLow"); 

  //analysis->plotIncSS("pZeta-1.5*pZetaVis",25,-150,100,1,-1,analysis->getSMcut(5),22,"pZeta-1.5*pZetaVis","",c4,0,"MSSBJetLow");
  //analysis->plotInc("pZeta-1.5*pZetaVis",25,-150,100,1,-1,analysis->getSMcut(5),"",4,0,"pZeta-1.5*pZetaVis","",c4,0,"MSSBJetLow");
  //analysis->plotInc("metpt",15,0,150,1,101,analysis->getSMcut(5),"",4,22," MET   (GeV)","",c,0,"MSSMBJetLow");    
  //analysis->plotInc("svfitmass",0,0,350,1,101,analysis->getSMcut(5),"(svfitmass<100)",4,22,"m(#tau#tau)  (GeV)","dN/dm(#tau#tau)",c4,10,"MSSMBJetLow"); 

  //analysis->plotIncSS("pZeta-1.5*pZetaVis",25,-150,100,1,-1,analysis->getSMcut(6),0,"pZeta-1.5*pZetaVis","",c4,0,"MSSBJetLow");
  //analysis->plotInc("pZeta-1.5*pZetaVis",25,-150,100,1,-1,analysis->getSMcut(6),"",4,0,"pZeta-1.5*pZetaVis","",c4,0,"MSSBJetLow");
