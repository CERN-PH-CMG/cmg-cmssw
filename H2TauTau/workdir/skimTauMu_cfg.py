...
process.cmgTauMuPreSel.cut = cms.string('leg1().eta()!=leg2().eta() && leg1().pt()>18.0 && abs(leg1().eta())<2.3 && leg1().tauID("decayModeFinding")>0.5 && leg2().pt()>16.0 && abs(leg2().eta())<2.1' )
...
process.out.outputCommands.extend( [
    'keep cmgMuon_*_*_H2TAUTAU',
    'keep cmgTau_*_*_H2TAUTAU',
