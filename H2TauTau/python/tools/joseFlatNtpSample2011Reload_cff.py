...
def configureFlatNtpSampleTauEle(module,sampleAlias):
    ...
    if sampleAlias == 'EmbeddedMay' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2011A_10May2011_v1_embedded_trans1_tau115_ptelec1_17had1_17_v3-f456bdbb960236e5c696adfe9b04eaae/USER/V5"
        module.dataType = 2

    if sampleAlias == 'EmbeddedV4' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2011A_PR_v4_embedded_trans1_tau115_ptelec1_17had1_17_v3-f456bdbb960236e5c696adfe9b04eaae/USER/V5"
        module.dataType = 2

    if sampleAlias == 'EmbeddedAug' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2011A_05Aug2011_v1_embedded_trans1_tau115_ptelec1_17had1_17_v3-f456bdbb960236e5c696adfe9b04eaae/USER/V5"
        module.dataType = 2

    if sampleAlias == 'EmbeddedOct' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2011A_03Oct2011_v1_embedded_trans1_tau115_ptelec1_17had1_17_v3-f456bdbb960236e5c696adfe9b04eaae/USER/V5"
        module.dataType = 2

    if sampleAlias == 'Embedded2011B' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2011B_PR_v1_embedded_trans1_tau115_ptelec1_17had1_17_v3-f456bdbb960236e5c696adfe9b04eaae/USER/V5"
        module.dataType = 2
...
def configureFlatNtpSampleTauEle2012(module,sampleAlias):
    ...
    if sampleAlias == 'Embedded2012A' :
        module.path = "/DoubleMu/StoreResults-DoubleMu_2012A_PromptReco_v1_embedded_trans1_tau115_ptelec1_17had1_17_v2-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V5_4_0_NewType1MET"
        module.dataType = 2

    if sampleAlias == 'Embedded2012B1' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2012B_PromptReco_v1_Run193752to195135_embedded_trans1_tau115_ptelec1_17had1_17_v2-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V5_4_0_NewType1MET"
        module.dataType = 2

    if sampleAlias == 'Embedded2012B2' : 
        module.path = "/DoubleMu/StoreResults-DoubleMu_2012B_PromptReco_v1_Run195147to196070_embedded_trans1_tau115_ptelec1_17had1_17_v2-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V5_4_0_NewType1MET"
        module.dataType = 2
