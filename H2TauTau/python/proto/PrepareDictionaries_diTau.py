...
def componentsWithData (selComps, weights) :
	...
	if 'embed_Run2012D_PromptReco_v1' in selComps.keys():
      ...
      #selCompsDataMass[mPoint]['GluGluToHToBB125']         = copy.deepcopy(selComps['GluGluToHToBB125'])
      #selCompsDataMass[mPoint]['VBF_HToBB125']         = copy.deepcopy(selComps['VBF_HToBB125'])
      #selCompsDataMass[mPoint]['TTH_HToBB125']         = copy.deepcopy(selComps['TTH_HToBB125'])
	...
	if 'embed_Run2012D_PromptReco_v1' in selComps.keys():
      ...
      #weightsDataMass[mPoint]['GluGluToHToBB125']         = copy.deepcopy(weights['GluGluToHToBB125'])
      #weightsDataMass[mPoint]['VBF_HToBB125']         = copy.deepcopy(weights['VBF_HToBB125'])
      #weightsDataMass[mPoint]['TTH_HToBB125']         = copy.deepcopy(weights['TTH_HToBB125'])
