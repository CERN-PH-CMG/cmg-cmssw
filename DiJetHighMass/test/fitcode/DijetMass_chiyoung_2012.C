...
//  inputFile = TFile::Open("../../data/histograms_data_HT_Run2011AB_160404_180252_Fat30_ak5_4677pbm1.root", "READ");
  ...
  */
  ...
  g->GetXaxis()->SetRangeUser(700,4400.0);
 ...
 for (int iWindow = 0; iWindow < 30; iWindow++){ 
   ...
   ((TGraphAsymmErrors*) aData->At(iWindow))->GetXaxis()->SetRangeUser(700,4400.0);
...
c01->SaveAs("Plots/DijetMassCrossSectionWithWindowFits.eps");
  ...
  //   htmp2->Draw("same");
  gratio->Draw("PSAME");
  TLine *l = new TLine(700, 1., 4400., 1.);
  l->Draw("same");
...
//       }	
  ...
  gWithSignal->GetXaxis()->SetRangeUser(700,4400.0);
  ...
  TH1F *vFrame = gPad->DrawFrame(700.0,0.000001,4400.0,10.0);
  vFrame->SetTitle("");
 ...
 //Dijet Mass Cross Section with Fit	
  ...
  ((TGraphAsymmErrors*) aRatio->At(0))->GetXaxis()->SetRangeUser(700,4400.0);
 ...
 //Dijet Mass Cross Section with Fit pulls
  ...
  hratio->SetMarkerStyle(20);
  hratio->GetXaxis()->SetRangeUser(700.,4400.);
  ...
  c11->cd(1);
    ...
    TH1F *vFrame = p11_1->DrawFrame(700.0,0.0000003,4400.0,10.0);
    vFrame->SetTitle("");
    vFrame->SetXTitle("Dijet Mass (GeV)");
    vFrame->GetXaxis()->SetTitleSize(0.06);
    vFrame->SetYTitle("d#sigma/dm (pb/GeV)");
    ...
    h->Draw("SAMEC");
    //   h->GetXaxis()->SetRangeUser(700.,4400.);
    ...
    TH1F *vFrame2 = p11_2->DrawFrame(700.0, -3.31, 4400.0, 3.31);
    vFrame2->SetTitle("");
