...
void DijetMass_chiyoung_JetMass(){
  ...
  //  pave_fit->AddText("M_{jj} > 1058 GeV");
...
//  pave->AddText("Coucou"); 
  ...
  */
  ...
  cout << "Fit QCD " << endl << endl << endl;
   ...
   // QCD Fit -- fit to qcd
   TF1 *f_qcd = new TF1("fit_qcd",fitQCD,1058.0,4200.0,4); 
  ...
  cout << "Fit QCD Up" << endl << endl << endl;
   ...
   TF1 *f_qcd_up = new TF1("fit_qcd_up",fitQCD,1058.0,4200.0,4); 
   gStyle->SetOptFit(1111); 
   ...
   TF1 *f_qcd_down = new TF1("fit_qcd_down",fitQCD,1058.0,4200.0,4); 
   gStyle->SetOptFit(1111); 
   ...
   for(i=0;i<hDijetMass->GetNbinsX();i++)
	...
	else if (n<25 && mass<=1058 && mass>3854 && n>0)
	{
		nl = n-0.5*TMath::ChisquareQuantile(a,2*n);
		nh = 0.5*TMath::ChisquareQuantile(1-a,2*(n+1))-n;
		veyl[i] = nl/(lumi*dm);
   ...
   // these are the graph format of data.
    ...
    // Fit to data    
    TF1 *fit = new TF1("fit",fitQCD1,1058.0,3854.0,4); // 4 Par. Fit
    gStyle->SetOptFit(1111); 
    ...
    fit->SetLineWidth(2);
    fit->SetLineColor(4);
    g->Fit("fit","","",1058.0,3854.0);	
    
    //Alternate Fits 4 parameter
    TF1 *f_4par = new TF1("fit_4par",fitQCD,1058.0,3854.0,4); // 4 Par. Fit
    gStyle->SetOptFit(1111); 
    f_4par->SetParameter(0,hDijetMass->Integral()/lumi/2000.);
    ...
    TF1 *f_3par = new TF1("fit_3par",fitQCD2,1058.0,3854.0,3); // 3 Par. Fit
    gStyle->SetOptFit(1111);
    f_3par->SetParameter(0, hDijetMass->Integral()/lumi/2000.*TMath::Power(7000., 5.));
    ...
    g->GetXaxis()->SetRangeUser(700,4200.0);
    g->GetYaxis()->SetRangeUser(0.000001,50);
    g->Draw("APZ");
    ...
    leg->Draw("same");
    pave_fit->Draw("same");
    c1->SaveAs("Plots_JetMass/DijetMassCrossSectionWithFit.png");
    c1->SaveAs("Plots_JetMass/DijetMassCrossSectionWithFit.eps");
    ...
    g2->Draw("APZ");
    g2->Fit("fit","","sames",1058.0,3854.0);

    TString status_default= gMinuit->fCstatu.Data();
    g2->Fit("fit_4par","+","sames",1058.0,3854.0);
    TString status_4par= gMinuit->fCstatu.Data();
    g2->Fit("fit_3par","+","sames",1058.0,3854.0);
    ...
    //    hJESminus->SetLineColor(5);
    htmp->GetXaxis()->SetRangeUser(700,4200);
    htmp->SetFillColor(5);
    htmp->SetLineColor(1);
    htmp->SetLineWidth(1); 
    htmp->SetLineColor(5);
    c2->SaveAs("Plots_JetMass/DijetMassCrossSectionWithAllFit.png");
    c2->SaveAs("Plots_JetMass/DijetMassCrossSectionWithAllFit.eps");
   ...
   c3->SaveAs("Plots_JetMass/DijetMassCrossSectionWithFitAndQCDMC.png");
   c3->SaveAs("Plots_JetMass/DijetMassCrossSectionWithFitAndQCDMC.eps");
   ...
   h2->Draw("C");  
   h2->SetTitle("");
   h2->GetXaxis()->SetRangeUser(700.,4200.);
   ...
   //   htmp2->Draw("same");
   gratio->Draw("PSAME");
   TLine *l = new TLine(700, 1., 4200., 1.);
   l->Draw("same");
   ...
   c4->SaveAs("Plots_JetMass/RatioDataPYTHIA.png");
   c4->SaveAs("Plots_JetMass/RatioDataPYTHIA.eps");
  ...
  // The end of comparison between data and PTYHIA QCD MC
   ...
   TH1F *vFrame = gPad->DrawFrame(700.0,0.000001,4200.0,10.0);
   vFrame->SetTitle("");
   ...
   TPaveText *pt_c5_qstar2 = new TPaveText(0.32,0.25,0.47,0.35,"NDC");
   ...
   c5->SaveAs("Plots_JetMass/DijetMassCrossSectionWithSignal.png");
   c5->SaveAs("Plots_JetMass/DijetMassCrossSectionWithSignal.eps");
   ...
   hDiff->GetXaxis()->SetRangeUser(700.,4200.);
   hDiff->GetYaxis()->SetRangeUser(-1.5,3.);
   hDiff->Draw("APZ");
   gr_qstar1_3->Draw("Lsame");
   gr_qstar2_3->Draw("Lsame");
   l = new TLine(700, 0.0, 4200, 0.0);
   l->SetLineStyle(2);
   l->Draw("same");
   pave->Draw("same");

   TPaveText *pt_c6_qstar1 = new TPaveText(0.20,0.3,0.35,0.4,"NDC");
   ...
   TPaveText *pt_c6_qstar2 = new TPaveText(0.40,0.3,0.55,0.4,"NDC");
   ...
   c6->SaveAs("Plots_JetMass/DataMinusFitDividedByFit.png");
   c6->SaveAs("Plots_JetMass/DataMinusFitDividedByFit.eps");


   TCanvas* c7 = new TCanvas("c7","(Data-Fit)/Error");
   hPulls->GetXaxis()->SetTitle("Dijet Mass (GeV)");
   hPulls->GetYaxis()->SetTitle("(Data-Fit)/Error");
   hPulls->GetXaxis()->SetRangeUser(700.,4200.);
   hPulls->GetYaxis()->SetRangeUser(-3.9,3.9);
   hPulls->SetLineWidth(1);
   hPulls->Draw("ep");
   l->Draw("same");  
	
   c7->SaveAs("Plots_JetMass/DataMinusFitDividedByError.png");
   c7->SaveAs("Plots_JetMass/DataMinusFitDividedByError.eps");
   ...
   leg->Draw("same");
   c8->SaveAs("Plots_JetMass/DataMinusFitDividedByFitForAllFits.png");
   c8->SaveAs("Plots_JetMass/DataMinusFitDividedByFitForAllFits.eps");
   ...
   c9->SaveAs("Plots_JetMass/DataMinusFitDividedByErrorForAllFits.png");
   c9->SaveAs("Plots_JetMass/DataMinusFitDividedByErrorForAllFits.eps");	
   ...
   hratio->SetMarkerStyle(20);
   hratio->GetXaxis()->SetRangeUser(700.,4200.);
   ...
   c10->SaveAs("Plots_JetMass/DataMinusFitWithAllSignal.png");
   c10->SaveAs("Plots_JetMass/DataMinusFitWithAllSignal.eps");
   ...
   c11->SaveAs("Plots_JetMass/DefaultFitAndPull.png");
   c11->SaveAs("Plots_JetMass/DefaultFitAndPull.eps");
