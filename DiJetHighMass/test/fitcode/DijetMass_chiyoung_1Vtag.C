...
//  lumi = 2509.0;
  ...
  // Input Files  
  TFile *inputFile = TFile::Open("../../../../UserCode/hinzmann/graviton/plots/lumi46fb_dataMC_data_1tag.root", "READ");



  // Histograms 
  hDijetMass = (TH1F*) inputFile->Get("mjj norm-data 0False 1tag;1");
