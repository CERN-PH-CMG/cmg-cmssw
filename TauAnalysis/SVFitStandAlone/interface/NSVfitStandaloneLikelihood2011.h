#ifndef TauAnalysis_SVFitStandAlone_NSVfitStandaloneLikelihood2011_h
#define TauAnalysis_SVFitStandAlone_NSVfitStandaloneLikelihood2011_h
...
namespace NSVfitStandalone2011{
  ...
  */
  ...
  /**
     \enum    NSVfitStandalone2011::kFitParams
  ...
  */
  ...
  /**
     \enum    NSVfitStandalone2011::kNLLParams
  ...
  */
  ...
  /**
     \class   MeasuredTauLepton NSVfitStandalone2011Likelihood2011.h "TauAnalysis/SVFitStandAlone/interface/NSVfitStandaloneLikelihood2011.h"
     
     \brief   Helper class to simplify the configuration of the NSVfitStandaloneLikelihood2011 class. 
     
     This is a helper class to facilitate the configuration of the NSVfitStandaloneLikelihood2011 class. It keeps the spacial momentum
  ...
  */
  class MeasuredTauLepton2011
  {
  public:
    /// constructor from the measured quantities per decay branch
    MeasuredTauLepton2011(kDecayType type, LorentzVector p4) : decayType_(type), p4_(p4) {};
    /// default destructor
    ~MeasuredTauLepton2011(){};
  ...
  /**
     \class   NSVfitStandaloneLikelihood2011 NSVfitStandaloneLikelihood2011.h "TauAnalysis/SVFitStandAlone/interface/NSVfitStandaloneLikelihood2011.h"
     ...
     The NSVfitStandaloneLikelihood2011 class is for internal use only. It is interfaced from the NSVfitStandaloneAlgorithm class as 
     ...
     function pointer gNSVfitStandaloneLikelihood2011 as defined in src/NSVfitStandaloneLikelihood2011.cc in the same package and 
     initialized in the function NSVfitStandaloneLikelihood2011::fnc(const double*). Per default the LogM term is added.
  */
  class NSVfitStandaloneLikelihood2011 {
  public:
    ///Jose: made TMatrixD a const pointer, it was being modified inside !
    /// constructor with a minimla set of configurables 
    NSVfitStandaloneLikelihood2011(std::vector<MeasuredTauLepton2011> measuredTauLeptons, Vector measuredMET,const TMatrixD * covMET, bool verbose);
    /// default destructor
    ~NSVfitStandaloneLikelihood2011() {};
    /// static pointer to this (needed for the minuit function calls)
    static const NSVfitStandaloneLikelihood2011* gNSVfitStandaloneLikelihood2011;
    ...
    std::vector<MeasuredTauLepton2011> measuredTauLeptons() const { return measuredTauLeptons_; };
  ...
  private:
    ...
    std::vector<MeasuredTauLepton2011> measuredTauLeptons_;
    /// measured MET
    Vector measuredMET_;
