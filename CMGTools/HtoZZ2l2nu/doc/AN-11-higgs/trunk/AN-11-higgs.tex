...
\RCS$Id: AN-11-higgs.tex,v 1.28 2011/09/13 16:09:33 psilva Exp $
%%%%%%%%%%%%% ptdr definitions %%%%%%%%%%%%%%%%%%%%%
...
Figure~\ref{fig:angles} shows schematically the observables used to implement the discriminant.
...
The output of the discriminant for different jet multiplicity bins is shown in Figs.~\ref{fig:likelihoodout_dimu}
and ~\ref{fig:likelihoodout_diele}. The distributions are shown for data and MC including all backgrounds
and the signal used for training.
...
\caption{Output of the likelihood discriminant for data and MC in the
  ...
  From {\em top} to {\em bottom} different signal masses are shown: from 200 to 600 GeV/c$^2$
