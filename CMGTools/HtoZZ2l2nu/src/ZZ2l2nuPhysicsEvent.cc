...
PhysicsEvent_t getPhysicsEventFrom(ZZ2l2nuSummary_t &ev)
{
  ...
  for(Int_t i=0;i<ev.jn;i++){
    ...
    phys.jets[i].btag5=ev.jn_btag5[i];
    phys.jets[i].btag6=ev.jn_btag6[i];
    phys.jets[i].btag7=ev.jn_btag7[i];
  ...
  for(Int_t i=0;i<ev.ajn;i++){
    ...
    phys.ajets[i].btag5=ev.ajn_btag5[i];
    phys.ajets[i].btag6=ev.ajn_btag6[i];
    phys.ajets[i].btag7=ev.ajn_btag7[i];
