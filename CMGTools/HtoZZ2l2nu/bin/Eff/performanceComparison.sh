...
root -l -b << EOF
 ...
 .x performanceComparison.C+("ImgDY/H200/", "mumu","H(200)","Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
  ...
  .x performanceComparison.C+("ImgSM/H300/", "mumu","H(200)","ZZ|WW|WZ|Single top|t#bar{t}|W+jets|Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
  .x performanceComparison.C+("ImgSM/H500/", "mumu","H(200)","ZZ|WW|WZ|Single top|t#bar{t}|W+jets|Z-#gamma^{*}+jets#rightarrow ll", "../../test/plotter.root");
EOF                                   
