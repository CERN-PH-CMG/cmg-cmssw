...
void formatForCmsPublic(TCanvas * c, TLegend *leg, TString title, int nsamp, float legx=0.7, float legy=0.91, float legw=0.23, float legh=0.05, TString legopt="lpf");
