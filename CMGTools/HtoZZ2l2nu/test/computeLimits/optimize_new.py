...
LandSArgCommonOptions=" --indexvbf 9 --subNRB --subDY $CMSSW_BASE/src/CMGTools/HtoZZ2l2nu/test/computeLimits_Morriond_13_01_16/gamma_half_2012_19_6fb.root --interf "
signalSuffixVec = []
OUTName         = []
LandSArgOptions = []

###################  #8TeV cut&count combined, GG, QQ
signalSuffixVec += ["", "", "_cp0.10_brn0.00", "_cp0.30_brn0.00", "_cp0.60_brn0.00", "", "_cp0.10_brn0.00", "_cp0.30_brn0.00", "_cp0.60_brn0.00"]; 
OUTName         += ["CC8TeV", "CC8TeV_GG", "CC8TeV_GG", "CC8TeV_GG", "CC8TeV_GG", "CC8TeV_QQ", "CC8TeV_QQ", "CC8TeV_QQ", "CC8TeV_QQ"]
LandSArgOptions += [" --bins eq0jets,geq1jets,vbf       --systpostfix _8TeV " for i in range(1)]
LandSArgOptions += [" --bins eq0jets,geq1jets --skipQQH --systpostfix _8TeV " for i in range(4)]
LandSArgOptions += [" --bins vbf              --skipGGH --systpostfix _8TeV " for i in range(4)]

###################  #8TeV shape combined, GG, QQ
signalSuffixVec += ["", "", "_cp0.10_brn0.00", "_cp0.30_brn0.00", "_cp0.60_brn0.00", "", "_cp0.10_brn0.00", "_cp0.30_brn0.00", "_cp0.60_brn0.00"]; 
OUTName         += ["SB8TeV", "SB8TeV_GG", "SB8TeV_GG", "SB8TeV_GG", "SB8TeV_GG", "SB8TeV_QQ", "SB8TeV_QQ", "SB8TeV_QQ", "SB8TeV_QQ"]
LandSArgOptions += [" --bins eq0jets,geq1jets,vbf       --systpostfix _8TeV --shape " for i in range(1)]
LandSArgOptions += [" --bins eq0jets,geq1jets --skipQQH --systpostfix _8TeV --shape " for i in range(4)]
LandSArgOptions += [" --bins vbf              --skipGGH --systpostfix _8TeV --shape " for i in range(4)]
...
for signalSuffix in signalSuffixVec :
   ...
   ######################################################################
      ...
      if(LandSArg.find('skip')<0):
         ...
         os.system("root -l -b -q plotLimit.C+'(\""+DataCardsDir+"\",\""+DataCardsDir+"/LimitTree.root\",\""+DataCardsDir+"/XSecs.txt\",  true, 8 , 19.6 )'")
   ######################################################################
