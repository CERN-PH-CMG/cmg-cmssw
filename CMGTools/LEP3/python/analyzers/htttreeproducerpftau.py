...
class htttreeproducerpftau( TreeAnalyzer ):
...
#
        ...
        fill('leadingMuon_en', subevent.leadingMuon_en)
        fill('leadingElectron_en', subevent.leadingElectron_en)
...
#                fill('t2_charge', subevent.taucandcharge[1])
                ...
                fParticleVars('t1rec',subevent.taucand[0])
                fParticleVars('t2rec',subevent.taucand[1])
