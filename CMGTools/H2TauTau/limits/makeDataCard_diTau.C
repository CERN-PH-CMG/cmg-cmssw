...
void makeDataCard_diTau(TString channel="tauTau",long sm=0, long mass=125){
...
//  TH1F* VH=  (TH1F*)rootfile.Get(ch+"_SM"+sm+"/VH"+mass);
  TH1F* SM=  (TH1F*)rootfile.Get(ch+"_SM"+sm+"/SM"+mass);
  TH1F* VBF= (TH1F*)rootfile.Get(ch+"_SM"+sm+"/VBF"+mass);
  TH1F* ZTT= (TH1F*)rootfile.Get(ch+"_SM"+sm+"/ZTT");
  TH1F* ZL=  (TH1F*)rootfile.Get(ch+"_SM"+sm+"/ZL");
  TH1F* ZJ=  (TH1F*)rootfile.Get(ch+"_SM"+sm+"/ZJ");
  TH1F* W=   (TH1F*)rootfile.Get(ch+"_SM"+sm+"/W");
  TH1F* TT=  (TH1F*)rootfile.Get(ch+"_SM"+sm+"/TT");
//  TH1F* VV=  (TH1F*)rootfile.Get(ch+"_SM"+sm+"/VV");
  TH1F* QCD= (TH1F*)rootfile.Get(ch+"_SM"+sm+"/QCD");
  TH1F* data_obs= (TH1F*)rootfile.Get(ch+"_SM"+sm+"/data_obs");
