...
cmgTauMuSelSumPtIsolationHistograms =cmgTauMuSelHistograms.clone()
cmgTauMuSelSumPtIsolationHistograms.inputCollection = cms.InputTag("cmgTauMuSelSumPtIsolation")
