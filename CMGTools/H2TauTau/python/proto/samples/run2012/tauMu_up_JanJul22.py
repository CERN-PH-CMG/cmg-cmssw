...
connect( allsamples, '%TAUMU_SVFitVEGASTESUp_Aug19_steggema', 'tauMu.*root', aliases, cache=True, verbose=False)
...
connect( mc_dy, '%TAUMU_SVFitVEGASTESUp_Aug26_steggema', 'tauMu.*root', aliases, cache=True, verbose=False)
