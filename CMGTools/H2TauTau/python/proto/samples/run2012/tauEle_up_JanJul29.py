...
connect( allsamples, '%TAUELE_SVFitVEGASTESUp_Aug12%', 'tauEle.*root', aliases, cache=True, verbose=False)
connect( data_list, '%TAUELE_SVFitVEGAS_Aug06%', 'tauEle.*root', aliases, cache=True, verbose=False)
connect( mc_dy, '%TAUELE_SVFitVEGASTESUp_Aug26%', 'tauEle.*root', aliases, cache=True, verbose=False)
