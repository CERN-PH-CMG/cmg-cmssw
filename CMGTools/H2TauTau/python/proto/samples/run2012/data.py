...
data_Run2012A = cfg.DataComponent(
    name = 'data_Run2012A',
    files = [],
    intLumi = 96.404 + 396.906 + 395.991, #double-checked with Jose
    triggers = [],
    json = None
    )
data_Run2012B = cfg.DataComponent(
    name = 'data_Run2012B',
    files = [],
    # intLumi = 4403., #  FIXME: x-check running
    intLumi = 4429.,
    triggers = [],
    json = None
    )
...
data_Run2012C = cfg.DataComponent(
    name = 'data_Run2012C',
    files = [],
    intLumi = 1783. + 5087. + 282.692, #double-checked with Jose
    triggers = [],
    json = None
    )
...
data_Run2012D = cfg.DataComponent(
    name = 'data_Run2012D',
    files = [],
    intLumi = 7318., #double-checked with Jose
    triggers = [],
    )
