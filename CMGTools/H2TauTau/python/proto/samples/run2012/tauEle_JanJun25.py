...
connect( allsamples, '%TAUELE_SVF%_Jun28%', 'tauEle.*root', aliases, cache=True, verbose=False)

# Accidentally named the e-tau embedded jobs TAUMU
connect( embed_list, '%PAT_CMG_V5_16_0_B%TAUMU_SVFit_Jun28_steggema', 'tauEle.*root', aliases, cache=True, verbose=False)
