...
data_Run2012A.files = getFiles('/TauPlusX/Run2012A-PromptReco-v1/RECO/{pat}_runrange_190605-194076/{htt}/Group'.format( pat=pat, htt=htt), user, filePattern, cache)
...
HiggsVBF115.files = getFiles(vbfpath.replace('HMASS','115'), user, filePattern, cache )
