...
from CMGTools.H2TauTau.proto.samples.triggers_tauEle import data_triggers_2011A, data_triggers_2011B, mc_triggers
...
# pat = '%TAUELE_TestMoriond3_ColinDec10'
pat = '%TAUELE_TestMoriond_FullSVFit_ColinDec11'
