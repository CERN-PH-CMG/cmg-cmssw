...
def saveForLimit(TightIsoOS, prefixLabel, mass, massType, category):
    ...
    #fileName = os.getcwd()+'/'+prefixLabel+'/'+prefixLabel+'_tauTau_'+category+'_mH'+str(mass)+'_'+TightIsoOS.varName+'.root'
...
def saveForPlotting(TightIsoOS, prefixLabel, mass):
    ...
    rootfile.cd(str(TightIsoOS.varName))
