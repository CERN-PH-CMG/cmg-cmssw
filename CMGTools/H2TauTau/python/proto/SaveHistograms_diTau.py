...
def saveForLimit(plotVarDataOS, prefixLabel, mass, massType, category):
    ...
    if plotVarDataOS.varName == massType+"" :
		...
		plotVarDataOS.Hist("DYJets").weighted.SetName("DYJets_Photon")
    ...
    if plotVarDataOS.varName == massType+"*1.03" :
		...
		plotVarDataOS.Hist("DYJets").weighted.SetName("DYJets_Photon_CMS_scale_tUp")
    ...
    if plotVarDataOS.varName == massType+"*0.97" :
		...
		plotVarDataOS.Hist("DYJets").weighted.SetName("DYJets_Photon_CMS_scale_tDown")
