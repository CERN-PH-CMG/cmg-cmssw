...
class H2TauTauTreeProducer( TreeAnalyzerNumpy ):
    ...
    def fillDiLepton( self, tree, diLepton):
        ...
        if hasattr(diLepton,'svfitMET'      ):
            self.fill(tree, 'svfitMET'      , diLepton.svfitMET().Rho()       )
            self.fill(tree, 'svfitME'       , sqrt(diLepton.svfitMET().mag2()))
            self.fill(tree, 'svfitMETPhi'   , diLepton.svfitMET().phi()       )
            self.fill(tree, 'svfitMEEta'    , diLepton.svfitMET().eta()       )
...
<<<<<<< HEAD
        self.var(tree, 'geninfo_nup'      , int)
        self.var(tree, 'geninfo_tt'    , int)
        self.var(tree, 'geninfo_mt'    , int)
        self.var(tree, 'geninfo_et'    , int)
        self.var(tree, 'geninfo_ee'    , int)
        self.var(tree, 'geninfo_mm'    , int)
        self.var(tree, 'geninfo_em'    , int)
        self.var(tree, 'geninfo_EE'    , int)
        self.var(tree, 'geninfo_MM'    , int)
        self.var(tree, 'geninfo_TT'    , int)
        self.var(tree, 'geninfo_LL'    , int)
        self.var(tree, 'geninfo_fakeid'   , int)
        self.var(tree, 'geninfo_has_w'     , int)
        self.var(tree, 'geninfo_has_z'     , int)
        self.var(tree, 'geninfo_mass'       )
        self.var(tree, 'genmet_pt'        )
        self.var(tree, 'genmet_px'        )
        self.var(tree, 'genmet_py'        )
        self.var(tree, 'genmet_phi'     )
    
    def fillGenInfo( self, tree, event ):
        #self.fill(tree, 'geninfo_nup'      , event.NUP       )
        self.fill(tree, 'geninfo_tt'    , event.geninfo_tt     )
        self.fill(tree, 'geninfo_mt'    , event.geninfo_mt     )
        self.fill(tree, 'geninfo_et'    , event.geninfo_et     )
        self.fill(tree, 'geninfo_ee'    , event.geninfo_ee     )
        self.fill(tree, 'geninfo_mm'    , event.geninfo_mm     )
        self.fill(tree, 'geninfo_em'    , event.geninfo_em     )
        self.fill(tree, 'geninfo_EE'    , event.geninfo_EE     )
        self.fill(tree, 'geninfo_MM'    , event.geninfo_MM     )
        self.fill(tree, 'geninfo_TT'    , event.geninfo_TT     )
        self.fill(tree, 'geninfo_LL'    , event.geninfo_LL     )
        self.fill(tree, 'geninfo_fakeid'   , event.geninfo_fakeid    )
        self.fill(tree, 'geninfo_has_w'     , event.geninfo_has_w      )
        self.fill(tree, 'geninfo_has_z'     , event.geninfo_has_z      )
        self.fill(tree, 'geninfo_mass'  , event.geninfo_mass   )
        self.fill(tree, 'genmet_pt'   , event.genmet_pt    )
        self.fill(tree, 'genmet_px'   , event.genmet_px    )
        self.fill(tree, 'genmet_py'   , event.genmet_py    )
        self.fill(tree, 'genmet_phi', event.genmet_phi )
