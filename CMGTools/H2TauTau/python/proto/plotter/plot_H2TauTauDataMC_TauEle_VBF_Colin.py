...
from CMGTools.H2TauTau.proto.plotter.plot_H2TauTauDataMC_TauEle_Inclusive_Colin import makePlot as makePlotInclusive
from CMGTools.H2TauTau.proto.plotter.plot_H2TauTauDataMC_TauEle_Inclusive_Colin import handleW as handleW
...
def makePlot( var, weights,
    ...
    qcd_cut = '&&'.join( [cat_Inc_AntiEleTauIsoJosh,
                          'diTau_charge!=0',
                          cat_VBF_Rel_20,
                          cut] )
...
if __name__ == '__main__':
    ...
    if qcd_vbf_eff is None:
        ...
        inc_qcd_cut = ' && '.join([cat_Inc_AntiEleTauIsoJosh,
                                   options.cut,
                                   'diTau_charge!=0'])
