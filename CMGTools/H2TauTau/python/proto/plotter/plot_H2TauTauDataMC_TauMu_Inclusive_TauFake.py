from CMGTools.H2TauTau.proto.plotter.plot_H2TauTauDataMC_TauMu_Inclusive import *
...
def fakeRate(opt, plot_iso, plot_antiso):
    if opt != 'mu' and opt != 'tau':
        print 'opt must be mu or tau.'
        return 
...
jose_qcdMuIsoRatio  = "((17<l2Jet_pt&&l2Jet_pt<=22)*1.51+(22<l2Jet_pt&&l2Jet_pt<=27)*0.462+(27<l2Jet_pt&&l2Jet_pt<=32)*0.2+(32<l2Jet_pt&&l2Jet_pt<=37)*0.12+(37<l2Jet_pt&&l2Jet_pt<=42)*0.101+(42<l2Jet_pt&&l2Jet_pt<=47)*0.0964+(47<l2Jet_pt&&l2Jet_pt<=52)*0.14+(52<l2Jet_pt&&l2Jet_pt<=57)*0.116)";
...
h_jose_qcdMuIsoRatio = cutstrToHist('jose_mu', jose_qcdMuIsoRatio)
...
##                       default=200)
    ...
    var = None
    if opt != 'mu' and opt != 'tau':
        print '3rd argument must be mu or tau.'
        sys.exit(1)
    elif opt == 'mu':
        var = 'l2Jet_pt'
        NBINS = 10
