...
def loadFlatNtpSamples(process):
    ...
    process.tauMuFlatNtpTauPlusXMay.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpTauPlusXv4.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpTauPlusXAug.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpTauPlusXOct3.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpTauPlusX2011B.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpEmbeddedMay.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpEmbeddedV4.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpEmbeddedAug.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpEmbeddedOct.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpEmbedded2011B.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpWJetsToLNu.diTauTag =  diTauColl
    process.tauMuFlatNtpWJetsToLNu.randsigma = 0.10
    ...
    process.tauMuFlatNtpW2JetsToLNu.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpW3JetsToLNu.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpTTJets.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpZToTauTau.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpZToMuMu.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpZToLJet.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpWW.diTauTag =  diTauColl
    ...
    process.tauMuFlatNtpWZ.diTauTag = diTauColl
    ...
    process.tauMuFlatNtpZZ.diTauTag = diTauColl
    ...
    for i in range(0,8):
        ...
        getattr(process,"tauMuFlatNtpHiggsGG"+HiggsMass[i]).diTauTag = diTauColl
        ...
        getattr(process,"tauMuFlatNtpHiggsVBF"+HiggsMass[i]).diTauTag = diTauColl
        ...
        getattr(process,"tauMuFlatNtpHiggsVH"+HiggsMass[i]).diTauTag = diTauColl
