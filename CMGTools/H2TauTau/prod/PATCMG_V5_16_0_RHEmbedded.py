...
#datasetInfo = ('cmgtools_group', '/DoubleMu/StoreResults-DoubleMu_Run2012A_13Jul2012_v1_embedded_trans1_tau132_pttau1_17had2_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/V5_B','.*root')
#datasetInfo = ('cmgtools_group', '/DoubleMu/StoreResults-DoubleMu_Run2012B_13Jul2012_v4_embedded_trans1_tau132_pttau1_17had2_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/V5_B','.*root')
#datasetInfo = ('cmgtools_group', '/DoubleMu/StoreResults-Run2012C_PromptReco_v2_embedded_trans1_tau132_pttau1_17had2_17_v2-5ef1c0fd428eb740081f19333520fdc8/USER/V5_B','.*root')
#datasetInfo = ('cmgtools_group', '/DoubleMu/StoreResults-DoubleMu_2012D_PromptReco_v1_embedded_trans1_tau132_pttau1_17had2_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/V5_B','.*root')
#datasetInfo = ('cmgtools_group', '/DoubleMuParked/StoreResults-Run2012B_22Jan2013_v1_RHembedded_trans1_tau116_ptmu1_16had1_18_v1-f456bdbb960236e5c696adfe9b04eaae/USER/V5_B','.*root')
datasetInfo = ('cmgtools_group', '/DoubleMuParked/StoreResults-Run2012B_22Jan2013_v1_RHembedded_trans1_tau116_ptmu1_16had1_18_v1-f456bdbb960236e5c696adfe9b04eaae/USER/V5_B','.*root')
...
#process.source.fileNames = ['/store/cmst3/group/cmgtools/CMG/DoubleMu/StoreResults-DoubleMu_Run2012C_24Aug2012_v1_embedded_trans1_tau116_ptmu1_13had1_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/V5_B/PFAOD_5.root']
...
#FIX for b-tagging: This not needed for rec-hit
#print 'Switching to tmfTracks: ak5JetTracksAssociatorAtVertex.tracks = tmfTracks'
#process.ak5JetTracksAssociatorAtVertex.tracks = 'tmfTracks'


#Fix for crash in Electron module(Maybe needed only for 2012D):
process.eleTriggerMatchHLT1.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT2.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT3.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT4.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT5.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT6.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT7.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT8.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT9.src = "patElectronsWithMVA"
process.eleTriggerMatchHLT10.src = "patElectronsWithMVA"
process.patElectronsWithTrigger.src = "patElectronsWithMVA"
process.PATElectronSequence.remove(process.patElectronsWithRegressionVars)

###Fix for crash in patJetsWithVar module looking for the original track refs, variables addded in this module are not needed
process.PATCMGJetSequence.remove(process.patJetsWithVar)
process.puJetId.jets = 'selectedPatJets'
process.outTracks.jets = 'selectedPatJets'
process.cmgPUJetMva.jets = 'selectedPatJets'
process.cmgPFJet.cfg.baseJetFactory.inputCollection = 'selectedPatJets'
process.cmgPFBaseJetAll.cfg.inputCollection =  'selectedPatJets'


###########Forget the CHS sequence 
...
####Fix for embedded samples
everything.extend(['keep recoGenParticles_*_*_*'])
...
## need to hack it for the embedded samples
if '13Jul2012'                in datasetInfo[1]:
    GT = 'FT_53_V6_AN3::All'
elif '06Aug2012'              in datasetInfo[1]:
    GT = 'FT_53_V6C_AN3::All'
elif 'Run2012C-PromptReco-v1' in datasetInfo[1]:
    GT = 'GR_P_V40_AN3::All'
elif 'Run2012C_PromptReco_v2' in datasetInfo[1]:
    GT = 'GR_P_V41_AN3::All'
elif '2012D_PromptReco_v1'    in datasetInfo[1]:
    GT = 'GR_P_V42_AN3::All'
elif '22Jan2013'    in datasetInfo[1]:
