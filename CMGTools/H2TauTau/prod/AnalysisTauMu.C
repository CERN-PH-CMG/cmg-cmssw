...
//int Analysis()
{
  ...
  WJetsToLNu.setOutputPath(path);
  WJetsToLNu.setDataType("MC");
  WJetsToLNu.setApplyRecoilCorr(1);
  WJetsToLNu.setColor(kRed+2);
  WJetsToLNu.setCrossection(31314);
  WJetsToLNu.setSampleGenEvents(23582137); //  52937030=CMG integrity, 53655290 = PFAOD integrity, 81352581 = "DBS"
  ...
  TTJets.setOutputPath(path);
  TTJets.setDataType("MC");
  TTJets.setColor(kBlue-8);
  TTJets.setCrossection(157.5);
  TTJets.setSampleGenEvents(3193095); //   3193095=CMG Tuple integrity, 3701947=Enriques PFAOD integrity, 3701947="DBS"
  ...
  DYJetsToLL.setOutputPath(path);
  DYJetsToLL.setDataType("MC");
  DYJetsToLL.setApplyRecoilCorr(1);
  DYJetsToLL.setColor(kOrange-4);
  DYJetsToLL.setCrossection(3048);
  DYJetsToLL.setSampleGenEvents(23862520);//   35101516=CMG integrity, 35035820=PFAOD integrity, 36277961="DBS"
  ...
  TauPlusXMay.setOutputPath(path);
  ...
  TauPlusXAug.setOutputPath(path);
  ...
  WJetsToLNu_SS.setOutputPath(path);
  ...
  DYJetsToLL_SS.setOutputPath(path);
  ...
  SingleMuMay_SS.setOutputPath(path);
  ...
  TauPlusXMay_SS.setOutputPath(path);
  ...
  TauPlusXv4_SS.setOutputPath(path);
  ...
  TauPlusXAug_SS.setOutputPath(path);
  ...
  TauPlusXv6_SS.setOutputPath(path);
...
//   analysis.plotDistribution("tauPtHisto",5," #tau p_{T}   (GeV)","Events / 5 GeV",c,r,0);
  ...
  //   Float_t c[4]={.5,.75,.42,.81};
  //   analysis.plotDistribution("tauIsoHisto",2," I^{#tau}_{abs}(#rho)   (GeV)","Events / 0.1 GeV",c,0);
...
//   analysis.plotDistribution("pZetaHisto_pzeta",6,"P_{#zeta} - 1.5*P_{#zeta}^{vis}    (GeV)","Events / 6 GeV",c,r);
  ...
  Float_t c[4]={.5,.75,.42,.81};
  Float_t r[4]={0,400,0,8000};
//   Float_t c[4]={.5,.75,.42,.81};
//   Float_t r[4]={0,350,5,1e7};
   analysis.plotDistribution("diTauMassHisto",10,"m_{vis}   (GeV)","Events / 10 GeV",c,r,0);
