...
TauMuPlotter * configTauMu2012D(TString name, TString path){  
  ...
  analysis->mTCut_=20;
  analysis->eventWeight_="pupWeights3*embeddedGenWeight*triggerEffWeightsTau3*selectionEffWeightsId3*selectionEffWeightsIso3*signalWeight";//triggerEffWeightsMu3*
