TauMuPlotter * tauMuConfig(const char * name){  
  ...
  //TString outpath="./output/Feb11";
  //TString outpath="./output/Feb11TauIso";
  //TString outpath="./output/Feb11TauIso2";
  //TString outpath="./output/Feb16";
  //TString outpath="./output/Feb19";
  //TString outpath="/data/benitezj/Samples/Feb19";
  //TString outpath="/data/benitezj/Samples/Feb22";
  //TString outpath="/data/benitezj/Samples/Feb23recoil";
  ...
  WJetsToLNu->setSampleGenEvents(81236081);                                  
  analysis->addSample(WJetsToLNu);  


  Sample* W2JetsToLNu = new Sample("W2JetsToLNu",outpath.Data());
  ...
  W2JetsToLNu->setSampleGenEvents(24923318); 
  analysis->addSample(W2JetsToLNu);  


  Sample* W3JetsToLNu = new Sample("W3JetsToLNu",outpath.Data());
  ...
  W3JetsToLNu->setSampleGenEvents(7551531); 
  ...
  TTJets->setSampleGenEvents(3685970); 
  ...
  ZToTauTau->setSampleGenEvents(28463829);// 28480417 need to revise this, this number was changing in the tau scale processings 
