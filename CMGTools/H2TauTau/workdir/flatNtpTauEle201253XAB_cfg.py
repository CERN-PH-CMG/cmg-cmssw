...
from CMGTools.H2TauTau.tools.joseFlatNtpSample53XAB_cff import configureFlatNtpSampleTauEle2012
...
process.cmgTauElePreSel.cut = cms.string('leg1().eta()!=leg2().eta() && leg1().pt()>20.0 && abs(leg1().eta())<2.3 && leg1().tauID("decayModeFinding")>0.5 && leg1().tauID("byRawIsoMVA")>0.5 && leg2().pt()>24.0 && abs(leg2().eta())<2.1' )
