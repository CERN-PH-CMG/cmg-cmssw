...
from CMGTools.H2TauTau.tools.joseFlatNtpSample44X_cff import configureFlatNtpSampleTauMu2011
...
#process.source.fileNames = ['file:/afs/cern.ch/user/b/benitezj/scratch0/CMGTools445_BleedingEdge/CMGTools/CMSSW_4_4_5/src/CMGTools/Common/prod/cmgTuple_181606.root']
#process.source.eventsToProcess = cms.untracked.VEventRange('1:181606')

###
#process.source.fileNames = ['/store/cmst3/user/cbern/CMG/VBF_HToTauTau_M-125_7TeV-powheg-pythia6-tauola/Fall11-PU_S6_START42_V14B-v1/AODSIM/V5_B/CMG_2011_V5_14_0_Test1/cmgTuple_1.root']
#process.source.fileNames = ['file:/afs/cern.ch/user/b/benitezj/scratch0/CMGTools445_BleedingEdge/CMGTools/CMSSW_4_4_5/src/CMGTools/Common/prod/cmgTuple_83403.root']
#process.source.eventsToProcess = cms.untracked.VEventRange('1:83403')
