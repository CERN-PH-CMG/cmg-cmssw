...
embed_May10ReReco_v1 = htt.EmbedComponent(
    ...
    files = '{baseDir}/DoubleMu/StoreResults-DoubleMu_2011A_May10thRR_v1_embedded_trans1_tau116_ptmu1_13had1_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V2_4_0/H2TAUTAU_Dec2/{filePattern}'.format(baseDir=baseDir, filePattern=filePattern),
    triggers = mc_triggers,
    tauEffWeight = mc_tauEffWeight,
    muEffWeight = mc_muEffWeight    
    ) 
...
embed_PromptReco_v4 = htt.EmbedComponent(
    ...
    files = '{baseDir}/DoubleMu/StoreResults-DoubleMu_2011A_PR_v4_embedded_trans1_tau116_ptmu1_13had1_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V2_4_0/H2TAUTAU_Dec2/{filePattern}'.format(baseDir=baseDir, filePattern=filePattern),
    triggers = mc_triggers,
    tauEffWeight = mc_tauEffWeight,
    muEffWeight = mc_muEffWeight    
    ) 
...
embed_05Aug2011_v1 = htt.EmbedComponent(
    ...
    files = '{baseDir}/DoubleMu/StoreResults-DoubleMu_2011A_Aug05thRR_v1_embedded_trans1_tau116_ptmu1_13had1_17_v2-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V2_4_0/H2TAUTAU_Dec2/{filePattern}'.format(baseDir=baseDir, filePattern=filePattern),
    triggers = mc_triggers,
    tauEffWeight = mc_tauEffWeight,
    muEffWeight = mc_muEffWeight    
    ) 
...
embed_03Oct2011 = htt.EmbedComponent(
    ...
    files = '{baseDir}/DoubleMu/StoreResults-DoubleMu_2011A_03Oct2011_v1_embedded_trans1_tau116_ptmu1_13had1_17_v1-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V2_4_0/H2TAUTAU_Dec2/{filePattern}'.format(baseDir=baseDir, filePattern=filePattern),
    triggers = mc_triggers,
    tauEffWeight = mc_tauEffWeight,
    muEffWeight = mc_muEffWeight    
    ) 
...
embed_2011B = htt.EmbedComponent(
    name = 'embed_2011B',
    files = '{baseDir}/DoubleMu/StoreResults-DoubleMu_2011B_PR_v1_embedded_trans1_tau116_ptmu1_13had1_17_v2-f456bdbb960236e5c696adfe9b04eaae/USER/PAT_CMG_V2_4_0/H2TAUTAU_Dec2/{filePattern}'.format(baseDir=baseDir, filePattern=filePattern),
    triggers = mc_triggers,
    tauEffWeight = mc_tauEffWeight,
    muEffWeight = mc_muEffWeight    
    ) 
