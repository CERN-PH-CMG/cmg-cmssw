...
if __name__ == '__main__':
    ...
    import glob
    fileList = glob.glob('SMS-T2tt_Mstop-225to1200_mLSP-50to1025_7TeV-Pythia6Z-Summer11-PU_START42_V11_FastSim-v1-wreece_030412-BPOG_*.root')
    #fileList = fileList[:2]
    oldTree = rt.TChain('RMRTree')
    for f in fileList:
        oldTree.Add(f)
    outputFile = rt.TFile.Open('sms-histos-T2tt-rb.root','recreate')
