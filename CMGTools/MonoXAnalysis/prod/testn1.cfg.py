...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('photon1jet')
)

# Output definition

process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('file:z1jet_LO_pT250_gen.root'),
...
process.source.fileNames = [ 'file:/afs/cern.ch/work/a/avartak/public/ZGammaFiles/z1jet_NLO_pT150.lhe' ]
process.output.fileName = '/afs/cern.ch/user/e/emanuele/w/monox/heppy/CMSSW_7_2_3_patch1/src/CMGTools/MonoXAnalysis/prod/testn1.root'
## If needed, select events to process
process.source.skipEvents = cms.untracked.uint32(10); process.maxEvents.input = cms.untracked.int32(10);
