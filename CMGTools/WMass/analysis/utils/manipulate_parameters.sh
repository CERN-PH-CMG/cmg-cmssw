#!\bin\bash
  ...
  # int WlikeCharge = PAR_WLIKE_CHARGE;
  sed "s:PAR_WLIKE_CHARGE:${10}:g" -i ${16}
...
# echo "PAR_ETA_CUT:${5} PAR_EFF_TOYS:${6} PAR_NPDF_SETS:${7} PAR_PDF_SETS:${8} PAR_PDF_MEMBERS:${9} PAR_TOYS_MOMCORR:${10}"
# echo "PAR_NPDF_SETS:${7} PAR_PDF_SETS:${8} PAR_PDF_MEMBERS:${9} PAR_WLIKE_CHARGE:${10} PAR_WMASS_VALUES_ARRAY:${11}"
