...
public:
  ...
  void Set_variation(int rapBinCorr, int DATAorMC, int U1orU2, int RecoilEigenNum, int RecoilVariationSigmas);
  void CorrectMET3gaus(double &pfmet, double &pfmetphi,double iGenPt,double iGenPhi,double iLepPt,double iLepPhi,double &iU1,double &iU2,int rapbin=1,int mytype=0);
