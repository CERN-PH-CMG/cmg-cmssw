                      ...
                      if(WlikePosCentral.Pt()<WMass::WpTcut*ZWmassRatio){ 
                        for(int k=0;k<WMass::NFitVar;k++)
                          ...
                          for(int h=0; h<WMass::PDF_members; h++){
                            ...
                            common_stuff::plot1D(Form("hWlikePos_u1_8_JetCut_pdf%d-%d%s%s_eta%s_%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,toys_str.Data(),Kalmantoys_str.Data(),eta_str.Data(),jZmass_MeV),
                              u1_dummy, evt_weight*TRG_TIGHT_ISO_muons_SF*lha_weight, h_1d, 50, -50, 50 );

                            common_stuff::plot1D(Form("hWlikePos_u2_8_JetCut_pdf%d-%d%s%s_eta%s_%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,toys_str.Data(),Kalmantoys_str.Data(),eta_str.Data(),jZmass_MeV),
                              u2_dummy, evt_weight*TRG_TIGHT_ISO_muons_SF*lha_weight, h_1d, 50, -50, 50 );

                            common_stuff::plot2D(Form("hWlikePos_uVec_8_JetCut_pdf%d-%d%s%s_eta%s_%d",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,toys_str.Data(),Kalmantoys_str.Data(),eta_str.Data(),jZmass_MeV),
                              u1_dummy, u2_dummy, evt_weight*TRG_TIGHT_ISO_muons_SF*lha_weight, h_2d, 50, -50, 50, 50, -50, 50 );
