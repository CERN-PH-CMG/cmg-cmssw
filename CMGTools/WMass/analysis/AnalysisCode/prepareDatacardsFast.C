              ...
              for(int n=0; n<WMass::KalmanNvariations; n++){
                ...
                for(int k=0;k<WMass::NFitVar;k++){
                  ...
                  for(int k2=k+1;k2<WMass::NFitVar-1;k2++){
                    ...
                    Datacard << "---------------------------------------------------------------------------------" << endl;
                    Datacard << "bin            Mu"<<Wlike.Data()<<WCharge_str[c].Data()<<"_eta"<<eta_str<<"          Mu"<<Wlike.Data()<<WCharge_str[c].Data()<<"_eta"<<eta_str<<"         Mu"<<Wlike.Data()<<WCharge_str[c].Data()<<"_eta"<<eta_str<< endl;
                    Datacard << Form("process        W%s%s_%sJets%s_%svs%s_pdf%d-%d%s        W%s%s_%sJets%s_%svs%sNonScaled_ALT        W%s%s_EWKTT_%sNonScaled_pdf%d-%d%s        ",Wlike.Data(),WCharge_str[c].Data(),WorZ.Contains("W")?"W":"DY",SigSample_str.Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,0, "",Wlike.Data(),WCharge_str[c].Data(),WorZ.Contains("W")?"W":"DY",SigSample_str.Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,0, "") << endl;
                    Datacard << "process              -1                            0                            1" << endl;
                    Datacard << "rate                 -1                           -1                           -1" << endl;
                    Datacard.close();
                  }
