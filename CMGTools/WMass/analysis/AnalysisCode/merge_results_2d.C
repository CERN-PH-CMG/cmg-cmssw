...
void merge_results_2d(int generated_PDF_set=1, int generated_PDF_member=0, TString WorZ="W", int useBatch=0, int RecoilCorrVarDiagoParU1orU2fromDATAorMC=0){
  ...
  outTXTfile.open(Form("../fit_results_2d.log"));
  outTXTfile << "# Syst\tStat" << endl;
  outTXTfile2.open(Form("../fit_results_chi2_2d.log"));
  ...
  for(unsigned int itoken=0; itoken<tokenized.size(); itoken++){
    ...
    TFile *fout = new TFile(Form("likelihood_results_W%s_2d.root",Wlike.Data()),"RECREATE");
        ...
        for(int k=0;k<WMass::NFitVar;k++){
          for(int k2=k+1;k2<WMass::NFitVar-1;k2++){
            ...
            for(int i=0; i<WMass::etaMuonNSteps; i++){
              ...
              g_deltaM_PDF[i][k][c]->SetName(Form("g_deltaM_PDF_W%s%s_%svs%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()));
              g_deltaM_PDF[i][k][c]->SetTitle(Form("g_deltaM_PDF_W%s%s_%svs%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()));
              g_deltaM_PDF[i][k][c]->SetMarkerStyle(20);
              h_deltaM_PDF[i][k][c] = new TH1D(Form("h_deltaM_PDF_W%s%s_%svs%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()),Form("h_deltaM_PDF_%svs%s_eta%s",WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()),200,-50,50);
            ...
            for(int i=0; i<WMass::etaMuonNSteps; i++){
              ...
              for(int k=0;k<WMass::NFitVar;k++){
                for(int k2=k+1;k2<WMass::NFitVar-1;k2++){
                  ...
                  result_NonScaled[i][m-m_start][h][k][c]->SetName(Form("likelihood_result_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,Kalmantoys_str.Data(),WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()));
                  result_NonScaled[i][m-m_start][h][k][c]->SetTitle(Form("likelihood_result_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,Kalmantoys_str.Data(),WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()));
                  ...
                  for(int j=0; j<2*WMass2::WMassNSteps+1; j++){
                    ...
                    // cout << Form("dummy_datacard_Wmass_Mu%s_pdf%d-%d%s%s_eta%s_%d_%svs%s.log ",WCharge_str[c].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,(RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):""),WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data(),jWmass,WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data());
                    TString test1 = Form("dummy_datacard_Wmass_Mu%s%s_pdf%d-%d%s%s_eta%s_%d_%svs%s.log",Wlike.Data(),WCharge_str[c].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,(RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):""),WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data(),jWmass,WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data());
                    // cout << test1 << endl;
                    ...
                    if(!TStringFromFile.Contains("-2 ln Q_{TEV}")){
                      ...
                      Form("dummy_datacard_Wmass_Mu%s_pdf%d-%d%s%s_eta%s_%d_%svs%s.log ",WCharge_str[c].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,(RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):""),WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data(),jWmass,WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data()) <<endl;
                      if (useBatch) {
                  ...
                  c_chi2=new TCanvas(Form("c_chi2_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()),Form("c_chi2_W%s_%svs%s_pdf%d-%d%s%s_eta%s",WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()));
                  ffit[i][k][c]=new TF1(Form("ffit_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()),Form("[0]+TMath::Power((x-[1]-%f)/[2],2)",offset_from_string(offset_string.Data(),1000)),70,100);
                  ...
                  int fires = result_NonScaled[i][m-m_start][h][k][c]->Fit(Form("ffit_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()),"WEM");
                  ...
                  for(int ifit=0;ifit<50;ifit++){
                    if((ffit[i][k][c]->GetChisquare()/ ffit[i][k][c]->GetNDF())>1e3 || TMath::Abs(ffit[i][k][c]->GetParameter(1) - (massCentral_MeV))>1e5 ){
                      ...
                      result_NonScaled[i][m-m_start][h][k][c]->Fit(Form("ffit_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()),"QWEM");
                      }
                  }
                  result_NonScaled[i][m-m_start][h][k][c]->Fit(Form("ffit_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()),"WEM");
                  ...
                  TLatex *text,*text2;
                  text = new TLatex(0.25,0.7,Form("Best M_{W%s} with %svs%s= %.1f #pm %.1f MeV", Wlike.Data(), WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),ffit[i][k][c]->GetParameter(1),ffit[i][k][c]->GetParameter(2)));
                  text->SetNDC();
                  text->Draw();
                  ...
                  // text2->SetNDC();
                  // text2->Draw();
                  cout << Form("Best M_W%s value with %svs%s = %.1f +/- %.1f MeV,\t DeltaM_W%s = %.1f +/- %.1f MeV,\t chi2/ndof= %.2f",Wlike.Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), ffit[i][k][c]->GetParameter(1), ffit[i][k][c]->GetParameter(2),Wlike.Data(), (ffit[i][k][c]->GetParameter(1) - (massCentral_MeV)), ffit[i][k][c]->GetParameter(2),(ffit[i][k][c]->GetChisquare()/ffit[i][k][c]->GetNDF())) << endl;
                  outTXTfile2 << Form("Best M_W%s %s value with %svs%s = %.1f +/- %.1f MeV,\t DeltaM_W%s = %.1f +/- %.1f MeV,\t chi2/ndof= %.2f",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), ffit[i][k][c]->GetParameter(1), ffit[i][k][c]->GetParameter(2),Wlike.Data(), (ffit[i][k][c]->GetParameter(1) - (massCentral_MeV)), ffit[i][k][c]->GetParameter(2),(ffit[i][k][c]->GetChisquare()/ffit[i][k][c]->GetNDF())) << endl;
              ...
              c_summary->SetGridy();
              c_summary->SetGridx();
              TH2D*frame=new TH2D("frame",Form("pdf %d-%d %s %s eta %s;M_{W%s} (MeV); -2ln(L/L_{ref})",WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data(),Wlike.Data()),2*WMass2::WMassNSteps+1,WorZ.Contains("Z")? WMass2::Zmass_values_array[0] : WMass2::Wmass_values_array[0],WorZ.Contains("Z")? WMass2::Zmass_values_array[2*WMass2::WMassNSteps] : WMass2::Wmass_values_array[2*WMass2::WMassNSteps],10,0,5);
              frame->Draw();
              ...
              cout << "ok35; TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN! TEMPORARY RETURN!" << endl;
              return;
              ...
              for(int k=0;k<WMass::NFitVar;k++){
                for(int k2=k+1;k2<WMass::NFitVar-1;k2++){
                  ...
                  // ffit[i][k]->Draw("");
                  cout << Form("ffit_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()) << endl;
                  result_NonScaled[i][m-m_start][h][k][c]->Print();
                  f[k] = (TF1*) result_NonScaled[i][m-m_start][h][k][c]->GetFunction(Form("ffit_W%s%s_%svs%s_pdf%d-%d%s%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets,h,RecoilCorrVarDiagoParU1orU2fromDATAorMC>0?Form("_RecoilCorrVar%d",m):"",WMass::KalmanNvariations>1?Form("_KalmanVar%d",n):"",eta_str.Data()));
                  cout << "ok37biss" << endl;
                  cout << f[k] << endl;
                  ...
                  leg1->AddEntry(f[k], Form("%svs%s Fit (#DeltaM_{W%s} = %.1f #pm %0.1f MeV)",WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),(f[k]->GetParameter(1) - (massCentral_MeV)),f[k]->GetParameter(2)), "l");
        ...
        for(int k=0;k<WMass::NFitVar;k++){
          for(int k2=k+1;k2<WMass::NFitVar-1;k2++){
            ...
            if(WMass::PDF_members>1){
              ...
              cout << Form("PDF %d with %svs%s: #DeltaM_{W%s, min}= %.1f MeV, #DeltaM_{W,max}= %.1f MeV", WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMmin[i][k][c], deltaMmax[i][k][c]) << endl;
              double denominator = 1;

              TCanvas*c1= new TCanvas(Form("c_deltaM_PDF_W%s%s_%svs%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()),Form("c_deltaM_PDF_W%s%s_%svs%s_eta%s",Wlike.Data(),WCharge_str[c].Data(),WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()));
              
              g_deltaM_PDF[i][k][c]->Draw("ape");
              TLatex *text;
              text = new TLatex(0.2,0.85,Form("W%s%s, PDF %d with %svs%s: #DeltaM_{W%s, min}= %.1f MeV, #DeltaM_{W%s,max}= %.1f MeV",Wlike.Data() , WCharge_str[c].Data(), WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMmin[i][k][c], Wlike.Data(),deltaMmax[i][k][c]));
              text->SetTextSize(0.035);
              text->SetNDC();
              text->Draw();
              
              if(usedpdf==232000 || usedpdf==229800){ // NNPDF, see ref. http://arxiv.org/pdf/1301.6754v1.pdf formulae 2.23 and 2.25
                // cout << Form("PDF %d with %s: #DeltaM_{W} square summed = -%.1f MeV, #DeltaM_{W} square summed = %.1f MeV", WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), deltaMnegSummed[i][k]/denominator, deltaMposSummed[i][k]/denominator) << endl;
                denominator = TMath::Sqrt(WMass::PDF_members/2-1);
                cout << Form("PDF %d with %svs%s: #DeltaM_{W%s} square summed = %.1f MeV", WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMSummed[i][k][c]/denominator) << endl;
                text = new TLatex(0.2,0.8,Form("PDF %d with %svs%s: #DeltaM_{W%s} square summed = %.1f MeV", WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMSummed[i][k][c]/denominator));
                text->SetTextSize(0.035);
                text->SetNDC();
                text->Draw();
              }else{
                cout << Form("PDF %d with %svs%s: #DeltaM_{W%s} as of J. Rojo = %.1f MeV", WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),Wlike.Data(), (deltaMJuan[i][k][c]/2/denominator)) << endl;
                text = new TLatex(0.2,0.8,Form("PDF %d with %svs%s: #DeltaM_{W%s} as of J. Rojo = %.1f MeV", WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets, WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),(deltaMJuan[i][k][c]/2/denominator)));
                text->SetTextSize(0.035);
                text->SetNDC();
                text->Draw();
              }
            ...
            if(m_end>1){
              cout << endl;
              // int usedpdf = WMass::PDF_sets<0?generated_PDF_set:WMass::PDF_sets;
              cout << Form("MomCorr toys with %svs%s: #DeltaM_{W%s, min}= %.1f MeV, #DeltaM_{W%s,max}= %.1f MeV", WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMmin[i][k][c], Wlike.Data(),deltaMmax[i][k][c]) << endl;
              double denominator = 1;

              TCanvas*c1= new TCanvas(Form("c_deltaM_PDF_%svs%s_eta%s",WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()),Form("c_deltaM_PDF_%svs%s_eta%s",WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(),eta_str.Data()));
              g_deltaM_PDF[i][k][c]->Draw("ape");
              TLatex *text;
              text = new TLatex(0.2,0.85,Form("MomCorr toys with %svs%s: #DeltaM_{W%s, min}= %.1f MeV, #DeltaM_{W%s,max}= %.1f MeV", WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMmin[i][k][c], Wlike.Data(),deltaMmax[i][k][c]));
              text->SetTextSize(0.035);
              text->SetNDC();
              text->Draw();
              ...
              // if(usedpdf==232000){ // NNPDF, see ref. http://arxiv.org/pdf/1301.6754v1.pdf formulae 2.23 and 2.25
                ...
                cout << Form("MomCorr toys with %svs%s: #DeltaM_{W%s} square summed = %.1f MeV", WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMSummed[i][k][c]/denominator) << endl;
                text = new TLatex(0.2,0.8,Form("MomCorr toys with %svs%s: #DeltaM_{W%s} square summed = %.1f MeV", WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), Wlike.Data(),deltaMSummed[i][k][c]/denominator));
                text->SetTextSize(0.035);
                text->SetNDC();
                text->Draw();
              // }else{
                // cout << Form("MomCorr toys with %s: #DeltaM_{W} as of J. Rojo = %.1f MeV", WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), (deltaMJuan[i][k]/2/denominator)) << endl;
                // text = new TLatex(0.2,0.8,Form("MomCorr toys with %s: #DeltaM_{W} as of J. Rojo = %.1f MeV", WMass::FitVar_str[k].Data(),WMass::FitVar_str[k2].Data(), (deltaMJuan[i][k]/2/denominator)));
                // text->SetTextSize(0.035);
                // text->SetNDC();
                // text->Draw();
              // }
