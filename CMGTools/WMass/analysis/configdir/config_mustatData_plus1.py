...
MuonCorrKalmanNvarsNsigma = 1  # vary each muon fit eigenv (0=no)
...
runPrepareDataCardsFast = 1  # TEMPLATES ARE IN THE TEMPLATE FOLDER, PSEUDO-DATA IN THE CURRENT FOLDER
