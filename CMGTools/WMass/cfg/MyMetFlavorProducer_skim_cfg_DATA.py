...
dataset_name = '/DoubleMu/Run2011A-ZMu-12Oct2013-v1/RAW-RECO/PAT_CMG_5_17_0'
...
process.mygammaPFmetPt0p0EtaMinm1p4EtaMax1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(0.0),
...
process.mygammaPFmetPt0p5EtaMinm5p0EtaMaxm3p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(0.5),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.mygammaPFmetPt0p5EtaMinm1p4EtaMax1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(0.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mygammaPFmetPt1p0EtaMinm5p0EtaMaxm3p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(1.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.mygammaPFmetPt1p0EtaMinm1p4EtaMax1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(1.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mygammaPFmetPt1p5EtaMinm5p0EtaMaxm3p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(1.5),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.mygammaPFmetPt1p5EtaMinm1p4EtaMax1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(1.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mygammaPFmetPt2p0EtaMinm5p0EtaMaxm3p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(2.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.mygammaPFmetPt2p0EtaMinm1p4EtaMax1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(2.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
# PT > 3.0
process.mygammaPFmetPt3p0EtaMinm5p0EtaMaxm3p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
process.mygammaPFmetPt3p0EtaMinm3p0EtaMaxm2p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-3.0),
                                                  candEtaMax      = cms.double(-2.4),
                                                  )
process.mygammaPFmetPt3p0EtaMinm2p4EtaMaxm2p1  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-2.4),
                                                  candEtaMax      = cms.double(-2.1),
                                                  )
process.mygammaPFmetPt3p0EtaMinm2p1EtaMaxm1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-2.1),
                                                  candEtaMax      = cms.double(-1.4),
                                                  )
process.mygammaPFmetPt3p0EtaMinm1p4EtaMax1p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
process.mygammaPFmetPt3p0EtaMin1p4EtaMax2p1  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(1.4),
                                                  candEtaMax      = cms.double(2.1),
                                                  )
process.mygammaPFmetPt3p0EtaMin2p1EtaMax2p4  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(2.1),
                                                  candEtaMax      = cms.double(2.4),
                                                  )
process.mygammaPFmetPt3p0EtaMin2p4EtaMax3p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(2.4),
                                                  candEtaMax      = cms.double(3.0),
                                                  )
process.mygammaPFmetPt3p0EtaMin3p0EtaMax5p0  =  process.mygammaPFmet.clone(
                                                  chargedCandPtMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(3.0),
                                                  candEtaMax      = cms.double(5.0),
                                                  )
...
process.myh0PFmetPt0p0EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(0.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myh0PFmetPt0p5EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(0.5),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.myh0PFmetPt0p5EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(0.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myh0PFmetPt1p0EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(1.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.myh0PFmetPt1p0EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(1.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myh0PFmetPt1p5EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(1.5),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.myh0PFmetPt1p5EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(1.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myh0PFmetPt2p0EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(2.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
...
process.myh0PFmetPt2p0EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(2.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
# P > 3.0
process.myh0PFmetPt3p0EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
process.myh0PFmetPt3p0EtaMinm3p0EtaMaxm2p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-3.0),
                                                  candEtaMax      = cms.double(-2.4),
                                                  )
process.myh0PFmetPt3p0EtaMinm2p4EtaMaxm2p1  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-2.4),
                                                  candEtaMax      = cms.double(-2.1),
                                                  )
process.myh0PFmetPt3p0EtaMinm2p1EtaMaxm1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-2.1),
                                                  candEtaMax      = cms.double(-1.4),
                                                  )
process.myh0PFmetPt3p0EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
process.myh0PFmetPt3p0EtaMin1p4EtaMax2p1  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(1.4),
                                                  candEtaMax      = cms.double(2.1),
                                                  )
process.myh0PFmetPt3p0EtaMin2p1EtaMax2p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(2.1),
                                                  candEtaMax      = cms.double(2.4),
                                                  )
process.myh0PFmetPt3p0EtaMin2p4EtaMax3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(2.4),
                                                  candEtaMax      = cms.double(3.0),
                                                  )
process.myh0PFmetPt3p0EtaMin3p0EtaMax5p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(3.0),
                                                  candEtaMin      = cms.double(3.0),
                                                  candEtaMax      = cms.double(5.0),
                                                  )
# P > 5.0
process.myh0PFmetPt5p0EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
process.myh0PFmetPt5p0EtaMinm3p0EtaMaxm2p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(-3.0),
                                                  candEtaMax      = cms.double(-2.4),
                                                  )
process.myh0PFmetPt5p0EtaMinm2p4EtaMaxm2p1  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(-2.4),
                                                  candEtaMax      = cms.double(-2.1),
                                                  )
process.myh0PFmetPt5p0EtaMinm2p1EtaMaxm1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(-2.1),
                                                  candEtaMax      = cms.double(-1.4),
                                                  )
process.myh0PFmetPt5p0EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
process.myh0PFmetPt5p0EtaMin1p4EtaMax2p1  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(1.4),
                                                  candEtaMax      = cms.double(2.1),
                                                  )
process.myh0PFmetPt5p0EtaMin2p1EtaMax2p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(2.1),
                                                  candEtaMax      = cms.double(2.4),
                                                  )
process.myh0PFmetPt5p0EtaMin2p4EtaMax3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(2.4),
                                                  candEtaMax      = cms.double(3.0),
                                                  )
process.myh0PFmetPt5p0EtaMin3p0EtaMax5p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(5.0),
                                                  candEtaMin      = cms.double(3.0),
                                                  candEtaMax      = cms.double(5.0),
                                                  )
# P > 10.0
process.myh0PFmetPt10p0EtaMinm5p0EtaMaxm3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(-5.0),
                                                  candEtaMax      = cms.double(-3.0),
                                                  )
process.myh0PFmetPt10p0EtaMinm3p0EtaMaxm2p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(-3.0),
                                                  candEtaMax      = cms.double(-2.4),
                                                  )
process.myh0PFmetPt10p0EtaMinm2p4EtaMaxm2p1  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(-2.4),
                                                  candEtaMax      = cms.double(-2.1),
                                                  )
process.myh0PFmetPt10p0EtaMinm2p1EtaMaxm1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(-2.1),
                                                  candEtaMax      = cms.double(-1.4),
                                                  )
process.myh0PFmetPt10p0EtaMinm1p4EtaMax1p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
process.myh0PFmetPt10p0EtaMin1p4EtaMax2p1  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(1.4),
                                                  candEtaMax      = cms.double(2.1),
                                                  )
process.myh0PFmetPt10p0EtaMin2p1EtaMax2p4  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(2.1),
                                                  candEtaMax      = cms.double(2.4),
                                                  )
process.myh0PFmetPt10p0EtaMin2p4EtaMax3p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(2.4),
                                                  candEtaMax      = cms.double(3.0),
                                                  )
process.myh0PFmetPt10p0EtaMin3p0EtaMax5p0  =  process.myh0PFmet.clone(
                                                  neutralCandPMin       = cms.double(10.0),
                                                  candEtaMin      = cms.double(3.0),
                                                  candEtaMax      = cms.double(5.0),
                                                  )
...
process.myhegammaHFPFmetPt0p0EtaMinm1p4EtaMax1p4  =  process.myhegammaHFPFmet.clone(
                                                  neutralCandPMin       = cms.double(0.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myhegammaHFPFmetPt0p5EtaMinm1p4EtaMax1p4  =  process.myhegammaHFPFmet.clone(
                                                  neutralCandPMin       = cms.double(0.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myhegammaHFPFmetPt1p0EtaMinm1p4EtaMax1p4  =  process.myhegammaHFPFmet.clone(
                                                  neutralCandPMin       = cms.double(1.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myhegammaHFPFmetPt1p5EtaMinm1p4EtaMax1p4  =  process.myhegammaHFPFmet.clone(
                                                  neutralCandPMin       = cms.double(1.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.myhegammaHFPFmetPt2p0EtaMinm1p4EtaMax1p4  =  process.myhegammaHFPFmet.clone(
                                                  neutralCandPMin       = cms.double(2.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mytkmethemuPFmetPt0p0EtaMinm1p4EtaMax1p4  =  process.mytkmethemuPFmet.clone(
                                                  chargedCandPtMin       = cms.double(0.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mytkmethemuPFmetPt0p5EtaMinm1p4EtaMax1p4  =  process.mytkmethemuPFmet.clone(
                                                  chargedCandPtMin       = cms.double(0.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mytkmethemuPFmetPt1p0EtaMinm1p4EtaMax1p4  =  process.mytkmethemuPFmet.clone(
                                                  chargedCandPtMin       = cms.double(1.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mytkmethemuPFmetPt1p5EtaMinm1p4EtaMax1p4  =  process.mytkmethemuPFmet.clone(
                                                  chargedCandPtMin       = cms.double(1.5),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.mytkmethemuPFmetPt2p0EtaMinm1p4EtaMax1p4  =  process.mytkmethemuPFmet.clone(
                                                  chargedCandPtMin       = cms.double(2.0),
                                                  candEtaMin      = cms.double(-1.4),
                                                  candEtaMax      = cms.double(1.4),
                                                  )
...
process.p = cms.Path( (process.cmgDiMuonSel +
                      ...
                      +process.mygammaPFmetPt0p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.mygammaPFmetPt0p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.mygammaPFmetPt1p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.mygammaPFmetPt1p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.mygammaPFmetPt2p0EtaMinm1p4EtaMax1p4
                      ...
                      # PT > 3.0
                      +process.mygammaPFmetPt3p0EtaMinm5p0EtaMaxm3p0
                      +process.mygammaPFmetPt3p0EtaMinm3p0EtaMaxm2p4
                      +process.mygammaPFmetPt3p0EtaMinm2p4EtaMaxm2p1
                      +process.mygammaPFmetPt3p0EtaMinm2p1EtaMaxm1p4
                      +process.mygammaPFmetPt3p0EtaMinm1p4EtaMax1p4
                      +process.mygammaPFmetPt3p0EtaMin1p4EtaMax2p1
                      +process.mygammaPFmetPt3p0EtaMin2p1EtaMax2p4
                      +process.mygammaPFmetPt3p0EtaMin2p4EtaMax3p0
                      +process.mygammaPFmetPt3p0EtaMin3p0EtaMax5p0
                      #h0
                      # P > 0.0
                      ...
                      +process.myh0PFmetPt0p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.myh0PFmetPt0p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.myh0PFmetPt1p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.myh0PFmetPt1p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.myh0PFmetPt2p0EtaMinm1p4EtaMax1p4
                      ...
                      # P > 3.0
                      +process.myh0PFmetPt3p0EtaMinm5p0EtaMaxm3p0
                      +process.myh0PFmetPt3p0EtaMinm3p0EtaMaxm2p4
                      +process.myh0PFmetPt3p0EtaMinm2p4EtaMaxm2p1
                      +process.myh0PFmetPt3p0EtaMinm2p1EtaMaxm1p4
                      +process.myh0PFmetPt3p0EtaMinm1p4EtaMax1p4
                      +process.myh0PFmetPt3p0EtaMin1p4EtaMax2p1
                      +process.myh0PFmetPt3p0EtaMin2p1EtaMax2p4
                      +process.myh0PFmetPt3p0EtaMin2p4EtaMax3p0
                      +process.myh0PFmetPt3p0EtaMin3p0EtaMax5p0
                      # P > 5.0
                      +process.myh0PFmetPt5p0EtaMinm5p0EtaMaxm3p0
                      +process.myh0PFmetPt5p0EtaMinm3p0EtaMaxm2p4
                      +process.myh0PFmetPt5p0EtaMinm2p4EtaMaxm2p1
                      +process.myh0PFmetPt5p0EtaMinm2p1EtaMaxm1p4
                      +process.myh0PFmetPt5p0EtaMinm1p4EtaMax1p4
                      +process.myh0PFmetPt5p0EtaMin1p4EtaMax2p1
                      +process.myh0PFmetPt5p0EtaMin2p1EtaMax2p4
                      +process.myh0PFmetPt5p0EtaMin2p4EtaMax3p0
                      +process.myh0PFmetPt5p0EtaMin3p0EtaMax5p0
                      # P > 10.0
                      +process.myh0PFmetPt10p0EtaMinm5p0EtaMaxm3p0
                      +process.myh0PFmetPt10p0EtaMinm3p0EtaMaxm2p4
                      +process.myh0PFmetPt10p0EtaMinm2p4EtaMaxm2p1
                      +process.myh0PFmetPt10p0EtaMinm2p1EtaMaxm1p4
                      +process.myh0PFmetPt10p0EtaMinm1p4EtaMax1p4
                      +process.myh0PFmetPt10p0EtaMin1p4EtaMax2p1
                      +process.myh0PFmetPt10p0EtaMin2p1EtaMax2p4
                      +process.myh0PFmetPt10p0EtaMin2p4EtaMax3p0
                      +process.myh0PFmetPt10p0EtaMin3p0EtaMax5p0
                      #hegammaHF
                      # P > 0.0
                      ...
                      +process.myhegammaHFPFmetPt0p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.myhegammaHFPFmetPt0p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.myhegammaHFPFmetPt1p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.myhegammaHFPFmetPt1p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.myhegammaHFPFmetPt2p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.mytkmethemuPFmetPt0p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.mytkmethemuPFmetPt0p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.mytkmethemuPFmetPt1p0EtaMinm1p4EtaMax1p4
                      ...
                      +process.mytkmethemuPFmetPt1p5EtaMinm1p4EtaMax1p4
                      ...
                      +process.mytkmethemuPFmetPt2p0EtaMinm1p4EtaMax1p4
