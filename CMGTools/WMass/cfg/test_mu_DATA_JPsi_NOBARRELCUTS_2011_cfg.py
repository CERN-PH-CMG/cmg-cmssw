...
from CMGTools.WMass.triggerMap import triggers_jpsi,triggers_jpsi_nobarrelcuts,triggers_upsilon,triggers_mu
...
WAna = cfg.Analyzer(
    ...
    savegenp = False,
    verbose = True,
    triggerBits = {'Dimuon10_Jpsi' : triggers_jpsi_nobarrelcuts},
...
data_Run2011A_Nov8ReReco_v1 = cfg.DataComponent(
    ...
    # triggers = ["HLT_IsoMu24_v1","HLT_IsoMu24_v2","HLT_IsoMu24_v3","HLT_IsoMu24_v4","HLT_IsoMu24_v5","HLT_IsoMu24_v6","HLT_IsoMu24_v7",\
                   ...
                   # ],
    triggers = triggers_jpsi_nobarrelcuts
               # +triggers_upsilon
               ,
