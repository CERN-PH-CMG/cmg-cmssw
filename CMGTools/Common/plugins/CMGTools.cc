...
DEFINE_FWK_MODULE(StructuredPFJetPOScaler);
...
DEFINE_FWK_MODULE(StructuredPFJetPOObjectSmear);
...
DEFINE_FWK_MODULE(StructuredPFJetPOProducer);
...
DEFINE_FWK_MODULE(LeadingCMGStructuredPFJetSelector);
...
DEFINE_FWK_MODULE(IndexCMGStructuredPFJetSelector);
...
DEFINE_FWK_MODULE(CmgStructuredPFJetSelector);
