...
runTriggers   = False ## Benjamin
printExpanded = True ## Benjamin
...
process.source = cms.Source("PoolSource",
      fileNames = cms.untracked.vstring(
            # 'file:////data/stiegerb/tH125q_blvYtMinus1_LHE_v1/Hadronizer_MgmMatchTuneZ2star_8TeV_madgraph_tauola_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_RECO_PU_PFAOD_V5.root'
            # 'file:////data/stiegerb/tH125q_blvYtMinus1_LHE_v1/Hadronizer_MgmMatchTuneZ2star_8TeV_madgraph_tauola_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_RECO_PU_7_1_tQN.root',
            # 'file:////data/stiegerb/tH125q_blvYtMinus1_LHE_v1/Hadronizer_MgmMatchTuneZ2star_8TeV_madgraph_tauola_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_RECO_PU_5_1_IPl.root'
            # 'file:////data/stiegerb/Summer12_DR53X/WZJetsTo3LNu_TuneZ2_8TeV-madgraph-tauola/AODSIM/PU_S10_START53_V7A-v1/0000/9CB5F4C2-D0DD-E111-8301-003048C69272.root'
            'root://xrootd.unl.edu//store/group/phys_higgs/malarosa/CRAB_MC_LHE_1M-125_-1/qtH-blv_1M-mH125Ct-1_Summer12_START50_V13_PU_2012_Startup_50ns_PoissonOOTPU/baa0761f571af28597b8a5a9cab3dae7/qtH-blv_1M-mH125Ct-1_Summer12_START50_V13_PU_2012_Startup_50ns_PoissonOOTPU_1000_1_xP9.root'
      )
...
if not runTriggers :
    ...
    process.patElectronsWithRegression.rhoCollection = cms.InputTag("kt6PFJets","rho")
...
if printExpanded:
    print sep_line
    print 'Saving expanded config'

    file = open('PATCMG_Expanded_cfg.py','w')
