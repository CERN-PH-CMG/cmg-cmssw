...
from CMGTools.SUSYAnalysis.tools.eventVars_1l_forBkg import EventVars1L_base
MODULES.append( ('1l_Basics', EventVars1L_base()) )

'''
from CMGTools.TTHAnalysis.tools.eventVars_1l_base import EventVars1L_base
MODULES.append( ('1l_Basics', EventVars1L_base()) )
from CMGTools.TTHAnalysis.tools.eventVars_1l_qcd import EventVars1L_QCD
MODULES.append( ('1l_TopVars', EventVars1L_QCD()) )
