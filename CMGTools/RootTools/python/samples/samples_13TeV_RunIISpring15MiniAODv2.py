...
TTLep_pow = kreator.makeMCComponent("TTLep_pow", "/TTTo2L2Nu_13TeV-powheg/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2-v1/MINIAODSIM", "CMS", ".*root", 57.35)
...
SingleTop = [
    TToLeptons_sch, TBar_tWch, T_tWch, tZq_ll, tZq_nunu
]
