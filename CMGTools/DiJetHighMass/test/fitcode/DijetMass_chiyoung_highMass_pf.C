...
void DijetMass_chiyoung_highMass_pf(){
...
//  inputFile = TFile::Open("histograms_data_HT_Run2010_2011_136033_180252_4479pbm1_ak5.root", "READ");
  ...
  // Histograms 
  hDijetMass = (TH1F*) inputFile->Get("h_DijetMass_data_pf;1");
...
//  pave->AddText("Coucou"); 
  ...
  */
  ...
  cout << "Fit QCD " << endl << endl << endl;
   ...
   // QCD Fit -- fit to qcd
   TF1 *f_qcd = new TF1("fit_qcd",fitQCD,944.0,4200.0,4); 
  ...
  cout << "Fit QCD Up" << endl << endl << endl;
   ...
   TF1 *f_qcd_up = new TF1("fit_qcd_up",fitQCD,944.0,4200.0,4); 
   gStyle->SetOptFit(1111); 
   ...
   TF1 *f_qcd_down = new TF1("fit_qcd_down",fitQCD,944.0,4200.0,4); 
   gStyle->SetOptFit(1111); 
