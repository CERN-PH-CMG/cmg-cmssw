...
void DijetMass_chiyoung_1Vtag_sbfit(){
...
//  pave->AddText("Coucou"); 
  ...
  */ 
  ...
  for (int iWindow = 0; iWindow < 10; iWindow++){
    ...
    fit_window->SetParameter(1,7.7);
    fit_window->SetParameter(2,8.4);
    fit_window->SetParameter(3,0.84);
    }
    if(iWindow==2)
    {
    fit_window->SetParameter(0,1.73132e-05*47976/47331);
    fit_window->SetParameter(1,7.7);
    fit_window->SetParameter(2,8.5);
    fit_window->SetParameter(3,0.84);
    }
    if(iWindow==3)
    {
    fit_window->SetParameter(0,1.73132e-05*47978/47331);
    fit_window->SetParameter(1,7.7);
    fit_window->SetParameter(2,8.5);
    fit_window->SetParameter(3,0.84);
    }
    if(iWindow==4)
    {
    fit_window->SetParameter(0,1.73132e-05*47943/47331);
    fit_window->SetParameter(1,7.08);
    fit_window->SetParameter(2,8.88);
    fit_window->SetParameter(3,0.93);
    }
    if(iWindow==5)
    {
    fit_window->SetParameter(0,1.73132e-05*47977/47331);
    fit_window->SetParameter(1,7.58);
    fit_window->SetParameter(2,8.53);
    fit_window->SetParameter(3,0.858);
    }
    if(iWindow==6)
    {
    fit_window->SetParameter(0,1.73132e-05*47935/47331);
    fit_window->SetParameter(1,7.60);
...
*/    if(iWindow==8)
    ...
    fit_window->SetParameter(2,8.9);
    fit_window->SetParameter(3,0.95);
    }
    if(iWindow==9)
    {
    fit_window->SetParameter(0,1.73132e-05*47976/47331);
  ...
  for (int iWindow = 1; iWindow < 9; iWindow++){
...
c01->SaveAs("Plots_1Vtag/DijetMassCrossSectionWithWindowFits.pdf");
 ...
 //Dijet Mass Cross Section with Fit	
  ...
  legw->AddEntry(((TGraphAsymmErrors*) aRatio->At(0)),"10 S+B-fits/Default Fit (4 par.)","L");
 ...
 //Dijet Mass Cross Section with Fit pulls
  ...
  legw2->AddEntry(((TGraphAsymmErrors*) aPull->At(0)),"10 S+B-fits - Default Fit (4 par.)","L");
  ...
  c100->SaveAs("Plots_1Vtag/DijetMassCrossSectionWithWindowFitPull.pdf");
   ...
   vFrame2->SetYTitle("(Data-Fit)/Fit");
