...
for ijob in range(1):
    ...
    outputfile.write("root -b -q \'ReadTree_MassList.C(\"" + inFile + "\", \"" + outLabel + "\")\' \n")
    outputfile.write("rfcp dijet_mass_fat_358pbm1_" + outLabel + ".txt /afs/cern.ch/user/m/mgouzevi/scratch0/CMGAnalysis/TEST/CMGTools/CMSSW_4_1_4/src/CMGTools/DiJetHighMass/prod/macros_KK/ControlPlots_Chiyoung/Plots_HT_CaloFat_740_380pb/out/res/dijet_mass_fat_358pbm1_" + outLabel + ".txt \n")
    outputfile.write("rm dijet_mass_fat_358pbm1_" + outLabel + ".txt")
    outputfile.close
