#ifndef TauAnalysis_SVFitStandAlone_NSVfitStandaloneAlgorithm_h
#define TauAnalysis_SVFitStandAlone_NSVfitStandaloneAlgorithm_h

#include "TauAnalysis/SVFitStandAlone/interface/NSVfitStandaloneLikelihood.h"
