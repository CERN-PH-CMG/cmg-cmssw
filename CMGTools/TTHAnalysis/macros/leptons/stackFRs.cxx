...
void loadData(TString iPrefix, int trig, int what) {
    ...
    if ((what <= 0 || what == 1 || what == 9 || what == 10 || what == 12 || what == 15 || what == 16 || what == 17 || what == 18) && fDQCD) {
    ...
    if ((what <= 0 || what == 2 || what == 11 || what == 12 || what == 15 || what == 16 || what == 17 || what == 18) && fDQCDJ) {
...
void stackFRs(int what=0, int idata=0, int itrigg=1) {
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        frame->GetYaxis()->SetRangeUser(0.0,0.2+0.2*(i==0)*(what<=17)+(0.4)*(what<0)+0.5*(what==18));
        ...
        frame->GetYaxis()->SetRangeUser(0.0,0.2+0.2*(i==0)+0.3*(idata)+0.4*(what==18));
