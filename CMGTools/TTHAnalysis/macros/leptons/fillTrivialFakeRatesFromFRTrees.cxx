...
void fillTrivialFakeRatesFromFRTrees(int triggering=1) {
    ...
    TString tightCEL = " && passEgammaTightMVA(Probe_pt,Probe_eta,Probe_tightId)";
    fillFR("FRC_tight_el",  baseCutL + tightCB + "Probe_mcMatchId == 0 && abs(Probe_pdgId) == 11"+tightCEL,         "Probe_relIso < 0.12",  "QCDMuPt15");
    fillFR("FRC_tight_mu",  baseCutL + tightCB + "Probe_mcMatchId == 0 && abs(Probe_pdgId) == 13 && Probe_tightId", "Probe_relIso < 0.12 ", "QCDMuPt15");
    fillFR("FRCj_tight_el", baseCutJ + tightCB + "Probe_mcMatchId == 0 && abs(Probe_pdgId) == 11"+tightCEL,         "Probe_relIso < 0.12",  "QCDMuPt15");
