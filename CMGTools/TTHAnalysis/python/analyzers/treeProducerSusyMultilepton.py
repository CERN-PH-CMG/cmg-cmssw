...
class treeProducerSusyMultilepton( treeProducerSusyCore ):
    ...
    def __init__(self, cfg_ana, cfg_comp, looperName):
        ...
        self.globalVariables += [
            ...
            NTupleVariable("nSoftBJetMedium25", lambda ev: sum((sv.mva>0.7 and (sv.jetPt < 25 or sv.jetBTag<0.679)) for sv in ev.ivf) + len(ev.bjetsMedium), int, help="Exclusive sum of jets with pt > 25 passing CSV medium and SV from ivf with medium sv mva"),
            ##--------------------------------------------------            
