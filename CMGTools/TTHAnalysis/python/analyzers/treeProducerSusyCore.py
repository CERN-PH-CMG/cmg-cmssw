...
class treeProducerSusyCore( ttHLepTreeProducerNew ):
    ...
    def __init__(self, cfg_ana, cfg_comp, looperName):
        ...
        self.collections = {
            ...
            "genleps"         : NTupleCollection("GenLep",     genParticleWithSourceType, 10, help="Generated leptons from W/Z decays"),
            "gentauleps"      : NTupleCollection("GenLepFromTau", genParticleWithSourceType, 10, help="Generated leptons from decays of taus from W/Z/h decays"),
