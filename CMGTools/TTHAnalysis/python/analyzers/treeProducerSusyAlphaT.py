...
susyAlphaT_collections.update({
    ...
    "cleanJetsAll"     : NTupleCollection("jet",      jetTypeSusy,             100, help="all jets (w/ x-cleaning, w/ ID applied w/o PUID applied pt > 40 |eta| < 3) , sorted by pt", filter=lambda l : l.pt()>40  ),
