...
combineCards.py .=2lss_MVA.card.txt  tl=3l_MVA.card.txt  ql=4l_nJet.card.txt > comb_MVA.card.txt
    ...
    for X in ee em mumu; do
        combineCards.py ss_${X/mumu/mm}_pos=2lss_${X}BCat_nJet_pos.card.txt \
                        ss_${X/mumu/mm}_neg=2lss_${X}BCat_nJet_neg.card.txt > 2lss_${X}BCat_QnJet.card.txt
        combineCards.py ss_${X/mumu/mm}_pos=2lss_${X}BCat_MVA_pos.card.txt \
                        ss_${X/mumu/mm}_neg=2lss_${X}BCat_MVA_neg.card.txt > 2lss_${X}BCat_QMVA.card.txt
    done
    combineCards.py .=2lss_eeBCat_QnJet.card.txt   \
                    .=2lss_mumuBCat_QnJet.card.txt \
                    .=2lss_emBCat_QnJet.card.txt     > 2lssBCat_QnJet.card.txt
    combineCards.py .=2lss_eeBCat_QMVA.card.txt   \
                    .=2lss_mumuBCat_QMVA.card.txt \
                    .=2lss_emBCat_QMVA.card.txt     > 2lssBCat_QMVA.card.txt

    combineCards.py tl_pos=3lBCat_nJet_pos.card.txt \
                    tl_neg=3lBCat_nJet_neg.card.txt > 3lBCat_QnJet.card.txt
    combineCards.py tl_pos=3lBCat_MVA_pos.card.txt \
                    tl_neg=3lBCat_MVA_neg.card.txt > 3lBCat_QMVA.card.txt
    combineCards.py .=2lssBCat_QnJet.card.txt tl=3lBCat_QnJet.card.txt ql=4l_nJet.card.txt > combBCat_QnJet.card.txt
    combineCards.py .=2lssBCat_QMVA.card.txt  tl=3lBCat_QMVA.card.txt  ql=4l_nJet.card.txt > combBCat_QMVA.card.txt
elif [[ "$1" == "BCat" ]]; then
    combineCards.py .=2lss_eeBCat_nJet.card.txt   \
                    .=2lss_mumuBCat_nJet.card.txt \
                    .=2lss_emBCat_nJet.card.txt     > 2lssBCat_nJet.card.txt
    combineCards.py .=2lss_eeBCat_MVA.card.txt   \
                    .=2lss_mumuBCat_MVA.card.txt \
                    .=2lss_emBCat_MVA.card.txt     > 2lssBCat_MVA.card.txt
    combineCards.py .=2lssBCat_nJet.card.txt tl=3lBCat_nJet.card.txt ql=4l_nJet.card.txt > combBCat_nJet.card.txt
    combineCards.py .=2lssBCat_MVA.card.txt  tl=3lBCat_MVA.card.txt  ql=4l_nJet.card.txt > combBCat_MVA.card.txt
