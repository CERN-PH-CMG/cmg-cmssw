...
J3="  -R 4j 3j 'nJet25 == 3' "
J3T="  -R 4j 3j 'nJet25 == 3 && LepGood2_pt > 20 && (LepGood1_pt+LepGood2_pt+met>100)' "
J4E="  -R 4j 4je 'nJet25 == 4' "
J4ET="  -R 4j 4je 'nJet25 == 4 && LepGood2_pt > 20 && (LepGood1_pt+LepGood2_pt+met>100)' "
LT="  -A 4j lt 'LepGood2_pt > 20 && (LepGood1_pt+LepGood2_pt+met>100)' "
BINCL=" -X 2B"
BLOOSE=" -I 2B"
...
2lss)
    ...
    RUN2EF="${RUN2E/mca-2lss-data/mca} --sp TT,TW --scaleSigToData $MVA1F "
    RUN2XF="${RUN2X/mca-2lss-data/mca} --sp TT,TW --scaleSigToData $MVA1F "
    #############################################################################
    ## ---- 4j fail MVA
    ...
    echo "python ${RUN2XF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/failLepMVA_pt2020_htllv100/em_TTscaled $LT        $BINCL             "
    echo "python ${RUN2XF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/failLepMVA_pt2020_htllv100/btight/em_TTscaled $LT $BTIGHT --rebin 4  "
    echo "python ${RUN2EF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/failLepMVA_pt2020_htllv100/ee_TTscaled $LT        $BINCL  --rebin 2  "
    echo "python ${RUN2EF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/failLepMVA_pt2020_htllv100/btight/ee_TTscaled $LT $BTIGHT --rebin 6  "
    echo "python ${RUN2MF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/failLepMVA_pt2020_htllv100/mumu_TTscaled $LT        $BINCL             "
    echo "python ${RUN2MF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/failLepMVA_pt2020_htllv100/btight/mumu_TTscaled $LT $BTIGHT --rebin 4  "
    ## ---- 3j fail MVA
    echo "python ${RUN2XF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/3j_failLepMVA/em_TTscaled $J3 $BINCL  "
    echo "python ${RUN2EF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/3j_failLepMVA/ee_TTscaled $J3 $BINCL  --rebin 2 "
    echo "python ${RUN2MF/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/3j_failLepMVA/mumu_TTscaled $J3 $BINCL  "
    ## ---- 3j pass MVA
    echo "python ${RUN2X/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/3j/em   $J3 $BINCL --rebin 4  "
    echo "python ${RUN2E/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/3j/ee   $J3 $BINCL --rebin 6  "
    echo "python ${RUN2M/cr_2lss_lowj_plots/mvaVars_2lss} $SF0 --pdir $ROOT/mvaVars/3j/mumu $J3 $BINCL --rebin 4  "
    ## ---- 3j fail MVA
...
3l_tight)
    ...
    RUN3LF="${RUN3L/mca-3l_tight-data/mca} --sp TT,TW --scaleSigToData $MVA2F "
    echo "python ${RUN3LF/PLOTS/mvaVars_3l} --pdir $ROOT/mvaVars/failLepMVA/TTscaled $SF0 $BINCL "
