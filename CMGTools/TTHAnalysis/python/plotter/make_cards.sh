...
if [[ "$1" == "" ]] || echo $1 | grep -q 2lss; then
    ...
    for X in 2lss_{mumu,ee,em}; do 
        ...
        J3="-R 4j 3j nJet25==3"
        #python makeShapeCards.py mca-2lss-dataBCat.txt bins/${X}_tight.txt 'MVA_2LSS_23j_6var' $J3 '4,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCat_3j_MVA_neg $MVA_2L $NEG $BAny;
        #python makeShapeCards.py mca-2lss-dataBCat.txt bins/${X}_tight.txt 'MVA_2LSS_23j_6var' $J3 '6,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCat_3j_MVA_pos $MVA_2L $POS $BAny;
        ...
        #python makeShapeCards.py mca-2lss-dataBCat_muSip4.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '4,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCatMuSip4_MVA_neg $MVA_2L $NEG $BAny  -A pt2010 sip4 "$SIP4";
        #python makeShapeCards.py mca-2lss-dataBCat_muSip4.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '6,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCatMuSip4_MVA_pos $MVA_2L $POS $BAny  -A pt2010 sip4 "$SIP4";
        #python makeShapeCards.py mca-2lss-dataBCat_muSip4.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '6,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCatMuSip4_MVA $MVA_2L $BAny           -A pt2010 sip4 "$SIP4";
        ...
        # ---- other random tests ----
        #python makeShapeCards.py mca-2lss-dataBCat.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '3,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCat_MVA_neg_bt $MVA_2L $NEG $BTight;
        #python makeShapeCards.py mca-2lss-dataBCat.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '4,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCat_MVA_pos_bt $MVA_2L $POS $BTight;
        #python makeShapeCards.py mca-2lss-dataBCat.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '4,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCat_MVA_neg_pt2010 $MVA_2L $NEG $BAny -R pt2020_htllv100 htll100 'LepGood1_pt+LepGood2_pt+met > 100';
        #python makeShapeCards.py mca-2lss-dataBCat.txt bins/${X}_tight.txt 'MVA_2LSS_4j_6var'  '6,-0.8,0.8' $SYSTS $OPT_2L -o ${X}BCat_MVA_pos_pt2010 $MVA_2L $POS $BAny -R pt2020_htllv100 htll100 'LepGood1_pt+LepGood2_pt+met > 100';
        if [[ "$X" != "2lss_mumu" ]]; then continue; fi
