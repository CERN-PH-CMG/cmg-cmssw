...
Hig125 = cfg.MCComponent(
    ...
    tfiles = ['root://eoscms//eos/cms/store/cmst3/user/pjanot/LEP3/ZZ/cmgTuple_ZZ_80.root',
    ...
    vfiles = ['root://eoscms//eos/cms/store/cmst3/user/pjanot/LEP3/QQBAR/cmgTuple_QQBAR_270.root',
