...
process.source.fileNames = cms.untracked.vstring(
  ' /store/mc/Summer12_DR53X/WToMuNu_TuneZ2star_8TeV_pythia6/ALCARECO/TkAlMuonIsolated-PU_S10_START53_V7A-v1/00000/FCE13AB9-13EB-E111-B324-003048FFCBA4.root'
 )
...
process.out.outputCommands += [ 'keep *_impactParameterTagInfos*_*_*',
...
### Jets
getattr(process,"patJets"+postfix).addTagInfos = cms.bool(True)
getattr(process,"patJets"+postfix).tagInfoSources = cms.VInputTag('secondaryVertexTagInfosAOD'+postfix,'secondaryVertexNegativeTagInfosAOD'+postfix)
