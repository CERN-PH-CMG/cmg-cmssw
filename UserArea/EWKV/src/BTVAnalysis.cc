...
//
BTVAnalysis::BTVAnalysis(SmartSelectionMonitor &mon)
  : mon_(&mon)
{
  ///////////////////////////////////
  // b-tagging                     //
  ///////////////////////////////////
  systVars_.push_back(""); systVars_.push_back("jesup"); systVars_.push_back("jesdown"); systVars_.push_back("jerup"); systVars_.push_back("jerdown"); systVars_.push_back("puup"); systVars_.push_back("pudown");
