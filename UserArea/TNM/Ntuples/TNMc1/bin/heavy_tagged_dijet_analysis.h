...
std::vector<double>	jethelper4_energy(10,0);
std::vector<double>	jethelper4_pt(10,0);
std::vector<double>	jethelper4_eta(10,0);
std::vector<double>	jethelper4_rapidity(10,0);
std::vector<double>	jethelper4_phi(10,0);
std::vector<double>	jethelper4_mass(10,0);
...
std::vector<double>	jethelper_tau1(10,0);
std::vector<double>	jethelper_tau2(10,0);
double	met2_energy;
double	met2_et;
double	met2_mEtSig;
double	met2_phi;
