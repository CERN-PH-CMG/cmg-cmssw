...
cms.EDAnalyzer("TheNtupleMaker",
    ...
    'float puJetId_leadPt()',
    'float puJetId_leadEta()',
    'float puJetId_leadPhi()',
    'float puJetId_secondPt()',
    'float puJetId_secondEta()',
    'float puJetId_secondPhi()',
    ...
    'float puJetId_pt2A()',
    'float puJetId_sumPt()',
    'float puJetId_leadFrac()',
    'float puJetId_secondFrac()',
