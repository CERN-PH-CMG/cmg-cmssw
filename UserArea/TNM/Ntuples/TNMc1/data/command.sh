...
ProductionTasks.py -w 'PFAOD*.root' -c -N 5 -q 2nd -t NTUPLE_Feb15 --output_wildcard '[!h]*.root' --batch_user tnm_group --cfg TNMc1_Feb15_cfg.py --max_threads 100 `cat data/samples_Moriond.txt`
...
cmsBatch.py 5 TNMc1_Feb15_FNAL_cfg.py -b 'bsub -q 2nd < ./batchScript.sh' -f -r /store/cmst3/user/hinzmann/NTUPLE/X_WW_lvjj_PS2000m-narrow-JHU -o X_WW_lvjj_PS2000m-narrow-JHU
cmsBatch.py 5 TNMc1_Feb15_FNAL_cfg.py -b 'bsub -q 2nd < ./batchScript.sh' -f -r /store/cmst3/user/hinzmann/NTUPLE/X_WW_lvjj_SM2000m-narrow-JHU -o X_WW_lvjj_SM2000m-narrow-JHU
