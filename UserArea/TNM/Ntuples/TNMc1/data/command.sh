...
ProductionTasks.py -w 'cmgTuple*.root' -c -N 5 -q 2nd -t NTUPLE_Feb15 --output_wildcard '[!h]*.root' --cfg TNMc1_Feb15_cfg.py --max_threads 100 `cat data/samples_Moriond.txt`
