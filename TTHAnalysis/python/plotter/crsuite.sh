...
CORE="mcPlots.py -P $T -j 6 --print=png,pdf -l 19.6 --showRatio --maxRatioRange 0 2.4 -f   --doStatTest=chi2l"
CORE="${CORE} --FM sf/t $T/0_SFs_v1/sfFriend_{cname}.root "

ROOT="plots/270413/cr/$WHAT"
...
zz_4l)
    ...
    SF="-W 'puWeight*Eff_4lep*SF_btag*SF_LepMVALoose_3l'"
