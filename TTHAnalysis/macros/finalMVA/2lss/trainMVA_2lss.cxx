void trainMVA_2lss(TString name) {
    ...
    TCut all = "nLepGood == 2 && LepGood1_charge == LepGood2_charge && nBJetLoose25 >= 2 && nJet25 >= 3";
    if (name.Contains("ttW")) {
        ...
        TFile *fBkg = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/TTJets/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
        TTree *tBkg = (TTree *) fBkg->Get("ttHLepTreeProducerBase");
        factory->AddBackgroundTree(tBkg, 1.0);
    } else if (name.Contains("mix")) {
        TFile *fBkg1 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/TTJets/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
        ...
        //TFile *fBkg3 = TFile::Open("/afs/cern.ch/work/b/botta/TTHAnalysis/trees/TREES_270213_HADD/TTLep/ttHLepTreeProducerBase/ttHLepTreeProducerBase_tree.root");
        //TTree *tBkg3 = (TTree *) fBkg3->Get("ttHLepTreeProducerBase");
        //factory->AddBackgroundTree(tBkg3,10.0); // charge misID is much smaller than fake rate
    } else  {
